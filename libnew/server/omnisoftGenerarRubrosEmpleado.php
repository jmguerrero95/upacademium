...
function GASTOSDEDUCIBLES() {
 ...
 function CALCULARIMPUESTORENTA($factor) {
   ...
   $sql="select  FRACCIONEXCEDENTE_TIR/100,FRACCIONBASICA_TIR,BASICA_TIR from tablaimpuestorenta where basica_tir<=".$ingresos.' and excedente_tir>='.$ingresos;
...
//           echo $SQLCmd;
       ...
       $SQLCmd="select * from  empleado where prospecto_epl='NO' and estado_epl='ACTIVO' and generarol_epl='SI'";
