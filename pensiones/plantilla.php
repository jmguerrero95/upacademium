	...
	<div id="contenedor">
		...
		<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" onClick="highlight(event)" onKeyUp="highlight(event)">
          ...
          <tr><td height="22" class="inputtitle">No de Matricula:</td><td colspan="3">
			 	<input type="text" name="serial_mmat" id="serial_mmat" size="9" class="integer"><span height="22" class="inputtitle"> Créditos: </span>
		  ...
		  <tr>	 <td height="22" class="inputtitle">Notas de Crédito: </td><td height="22" colspan="3">
