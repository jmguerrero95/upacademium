...
if($rs_acreditacion->fields['CONTROL_FORC']<>'')
 ...
 $SQLCommand="select serial_cdc,fechaefec_cdc,fdc.nombre_forc,cdc.valor_cdc, cdc.comision_cdc,cdc.estado_cdc,cdc.serial_cid,acd.serial_acd ,'NO' as registrado,descripcion_cdc
from cierredia cid,cierredia_control cdc, formacobro fdc,acreditacion_cierredia acd 
where ".$filtro."
and fdc.serial_forc=cdc.serial_forc 
and cid.serial_cid = cdc.serial_cid  
...
union
select cdc.serial_cdc,fechaefec_cdc,fdc.nombre_forc,cdc.valor_cdc, cdc.comision_cdc,cdc.estado_cdc,cdc.serial_cid ,acd.serial_acd,'SI' as registrado,descripcion_cdc
