 ...
 if($rscierrdia->RecordCount()==0){
   ...
   if($rs_periodo>0){
   	//	echo "entra";
		...
		and fecha_caf>='".$params[0]."' and fecha_caf<='".$params[1]."' and alumno.serial_alu=cabecerafactura.serial_alu  and cabecerafactura.serial_suc=".$serial_suc."  and estado_caf<>'ANULADO' ORDER BY tipo_caf, cabecerafactura.serial_caf,fecha_caf asc";						
						 //  echo $SQLCommand."<br>";						 
