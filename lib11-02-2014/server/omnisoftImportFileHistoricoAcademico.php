...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportFileHistoricoAcademico.php">
...
function omnisoftImportFile() {
  ...
  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademium/historicoacademico/'.$_FILES['foto']['name'];
