...
function insertarCabeceraComprobante($dblink,$fecha_com,$concepto_com,$monto_com,$estado_com,$serial_tic,$serial_usr,$serial_age,$numero_com,$codigo_com,$serial_per,$modulo) {
   ...
   $SQLCommand="insert into comprobante (serial_com,fecha_com,concepto_com,monto_com,estado_com,usuario_com,serial_tic,modulo_com,serial_age,codigo_com,numero_com,serial_per,generado_com) values (0,'".$fecha_com."','" .$concepto_com."',".$monto_com.",'".$estado_com."',".$serial_usr.",".$serial_tic.",'".$modulo."',".$serial_age.",'".$codigo_com."',".$numero_com.",".$serial_per.",'A')";
  //echo $SQLCommand."<br>";
