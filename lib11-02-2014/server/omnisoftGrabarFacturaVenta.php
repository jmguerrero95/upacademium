				...
				//INSERTA CREDITOS POR TOMAR EN LA TABLA CREDITOS POR TOMAR				
					if($tipo<>'NC'){					
						...
						$dblink->Execute($insertarPortomar);				
							...
							$consultarCreditosAfavor="SELECT afavor_cpt FROM cabeceracreditosportomar AS cpt WHERE cpt.serial_dfa IN(SELECT	serial_dfa FROM detallefactura AS dfa WHERE serial_caf = ".$params[13].")";																						
