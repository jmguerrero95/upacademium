...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportDocumentoHom.php">
...
function omnisoftImportDocumento() {
  ...
  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademium/documento/'.$_FILES['foto']['name'];
