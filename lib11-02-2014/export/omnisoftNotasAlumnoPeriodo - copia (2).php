...
if($arrCreditoGraduacionMalla){
	$totalCreditosGraduacionMalla = $arrCreditoGraduacionMalla;		
}else{
	$totalCreditosGraduacionMalla = 0;		
}
        ...
        <tr>
		 ...
		 <!-- <tr>
		  ...
		  <th >&nbsp; </th>		  
		   ...
		   <tr>
		     <th colspan="7" ><div align="right">TOTAL CREDITOS GRADUACION:</div></th>
...
function getCreditosGraduacionMalla($serial_alu,$serial_sec,$dblink){
	...
	if($ncredOther>0){
		//echo "<br>TOTAL C GRAUACION: <br>".$ncredOther."<br>";
		return $ncredOther;	
	}else{
		return false;
	}	
