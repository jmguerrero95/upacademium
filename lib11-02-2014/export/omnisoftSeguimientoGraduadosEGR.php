...
WHERE
	...
	".$seccion."
	".$sucursal."
	AND (fecegresamiento_ama >= '".$fecha_ini."' 
	AND fecegresamiento_ama <='".$fecha_fin."' and fectitulacion_ama='0000-00-00')
...
<table width="90%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <th colspan="2"><strong>LISTA GENERAL DE ALUMNOS EGRESADOS </strong></th>
  </tr>
  <tr >
