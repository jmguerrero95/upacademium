...
WHERE
	...
	AND detallemateriamatriculada.serial_mat not in (
        SELECT	
            mat.serial_mat
        FROM
            malla       AS maa,
...
for($i=0;$i<$totAll;$i++){	
	...
	if($arr){
		...
		//echo "DEL REGISTRO";
		$arrMain[$i]['tipomateria'] = "FUERA DE MALLA";
	}
}
...
<table width="80%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="71%" bgcolor="#FFFFFF"><table width="100%" border="0">
      <tr>
        <th >
          <p class="">MATERIA FUERA  DE MALLA </p></th>
      </tr>
	  <tr bgcolor="#FFFFFF">
