...
SELECT
	...
	alu.telefodomic_alu,alu.telefotrabajo_alu,celular_alu,
	per.nombre_per,
	nombre_suc,
	nombre_sec,
	per.serial_suc,
	...
	crp.nombre_crp,
	maa.serial_car,
	nombre_fac,descripcion_sex,fecegresamiento_ama
FROM
	sexo               AS sex,
	sucursal           AS suc,
	seccion            AS sec,
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
        ...
        <tr>
          <td  align="left" nowrap><? echo $i + 1; ?></td>
			   ...
			   <td  align="left" nowrap><? echo $arrMain[$i]['telefodomic_alu']." / ".$arrMain[$i]['telefotrabajo_alu']." / ".$arrMain[$i]['celular_alu'];?></td>
