...
//        require('omnisoftPDFIndividualMallas.php');
 ...
 ini_set ( 'sendmail_from' ,  'cristina.hidalgo@upacifico.edu.ec' ); 
...
$headers .= "From:cristina.hidalgo@upacifico.edu.ec\r\n"; 

//Dirección de respuesta (Puede ser una diferente a la de pepito@mydomain.com)
$headers .= "Reply-To: cristina.hidalgo@upacifico.edu.ec\r\n"; 

//Ruta del mensaje desde origen a destino 
$headers .= "Return-path: cristina.hidalgo@upacifico.edu.ec\r\n"; 
