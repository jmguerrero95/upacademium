...
for($i=0;$i<$totAll;$i++){	
	...
	$mail = strtolower($arrMain[$i]['mail_alu']);
	$msg = "<a href='mailto:".$mail."' target='_blank'><img border='0' width='30' src='../../images/imgmail.jpg' height='26'/></a>";
	$arr = getCumple($arrMain[$i]['fecnac_alu'],$dblink);
	if($arr){
		$arrMain[$i]['cumple'] = $msg;
	}
	switch($arrMain[$i]['sexo']){
		case "MASCULINO": 
			$totMasculino++;
			break;
		case "FEMENINO":
...
<table width="90%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <th colspan="2"><strong>LISTA DE ALUMNOS CON FECHA DE CUMPLEA&Ntilde;OS </strong></th>
  </tr>
  <tr >
  ...
  <tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		<tr>
		  ...
		  <th width="7%">FNACIMIENTO</th>
		  <th width="7%">CUMPLE</th>
		  <th width="7%">EMAIL</th>
		...
		<tr> 
				...
				<td nowrap="nowrap" ><span><?php echo $arrMain[$i]['fecnac_alu'];?></span></td>
				<td ><?php echo $arrMain[$i]['cumple'];?></td>
				<td ><span><?php echo strtolower($arrMain[$i]['mailuniv_alu']);?></span></td>
    ...
    <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0">
        <tr>
          ...
          <td width="51%" align="center"><div align="left">
			...
			<p>Cumpleañeros : <?php echo $totCumple;?></p>
          </div></td>
