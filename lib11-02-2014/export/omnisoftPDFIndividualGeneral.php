...
//------------------------------------------------------------------------------------------------------------------------
         ...
         class OmnisoftPDFIndividual extends FPDF {
               ...
               var $activeColumnDetailArray; // OBJECT, arreglo de todas las columnas
                ...
                function addColumn($AdisplayColumnName, $Awidth=20,$value=0,$posX=0,$posY=0,$Atype="string",$Aalign="left",$Afont='Arial',$Asize='18',$Abold=false,$Apagebreak=false)
                {
...
function printPage() {
               ...
               $this->SetLineWidth(.3);
				...
				$this->SetFont($arrayElement["font"],'',$arrayElement["size"]);
                             ...
                             $this->Cell($width,4,$arrayElement["displayColumnName"],1,0,'L',0);
     	...
     	//			$this->setFont($arrayElement["font"]," ",$arrayElement["size"]);
	                              if  ( $arrayElement["type"]=="string")
                                         $this->Cell($arrayElement["width"]-2,4,$rec,'L',0,'L',$fill);
                                  else  if  ( $arrayElement["type"]=="number")
                                         $this->Cell($arrayElement["width"]-2,4,$rec,'R',0,'R',$fill);
