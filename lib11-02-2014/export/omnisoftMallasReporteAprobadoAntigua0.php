...
<table width="305" border="1" align="center">
  ...
  <tr>
    <td width="39"><strong><font color='blue'>Azul</font></strong></td>
    <td width="250">Materia Aprobada </td>
  </tr>
  <tr>
    <td><strong><font color='green'>Verde</font></strong></td>
    <td>Materia en Curso o Abandonada </td>
  </tr>
  <tr>
	...
	if($arr = $dblink->GetAll($sqlGet)){		
		for($i=0;$i<count($arr);$i++){
			...
			if($arrAp){
				...
				//Verificar si esta cursando Actualmente
