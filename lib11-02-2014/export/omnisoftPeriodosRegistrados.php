...
FROM 
	...
	left join facultad on facultad.serial_fac=carrera.serial_fac
	 join sexo on alumno.serial_sex = sexo.serial_sex 
	left join colegios on alumno.serial_col = colegios.serial_col 
WHERE
...
while (!$rsalumnos->EOF) {
	...
	if (!in_array($rsalumnos->fields['nombre'],$nombres_alumnos)){
		...
		$colegio[$rsalumnos->fields['serial_alu']]=$rsalumnos->fields['nombre_col'];
		}
	$rsalumnos->MoveNext();
}
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
        <tr>
		  ...
		  <th width="20%" bgcolor="#999999">Apellido</th>
		  <th width="20%" bgcolor="#999999"><span class="style2">Nombre </span></th>
		  <th width="10%" bgcolor="#999999">Telf Dom </th>
		  <th width="10%" bgcolor="#999999">Tel. Cel </th>
		  <th width="10%" bgcolor="#999999">Colegio</th>
		...
		<? $i=1;
			...
			?>
				...
				<td NOWRAP><span class="style2"><? echo $colegio[$alumnos];?></span></td>
