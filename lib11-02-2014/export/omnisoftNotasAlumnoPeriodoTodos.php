...
for($i=0;$i<$totAll;$i++){		
	...
	$w++;
	//echo "</p> Numerica: ".$w.".- ".$totalNotaNumericaPorCredito." -Cre- ".$arrMain[$i]['creditomalla']." -NotNum- ".$arrMain[$i]['notanumerica']."</p>";
	...
	//		echo "</p>".$w."CREDITOS: ".$totalCreditosAprueba." - ".$arrMain[$i]['estado_nal'];
...
echo "</p> CREDITOS: ".$totalCreditosAprueba;
$totalCreditosAprueba = ($totalCreditosAprueba + $totalCreditosReprueba) - $totalRestarCredito;

echo "</p> *********........total: ".$w.".- ".$totalNotaFinal." -Nota- ".$totalNotaSobreCuatro." -Cre- ".$totalCreditosAprueba."/".$totalCreditosReprueba."</p>";
...
echo "</p> *********........total: ".$wo.".- ".$totalNotaFinal." -Nota- ".$getNotaHomologada." -Cre- ".$totalCreditosRevalidados."/".$totalCreditosHomologados."</p>";
