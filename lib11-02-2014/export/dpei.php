...
$campos_comunes = "
	...
	cargoaut_epl,
	fecha_inicio_aut_epl,
	fechaFinCargoAut_epl,
	NumDocumCargoAut_epl,
    nombre_tct,
    epl.serial_tct,
    fechanacimiento_epl,
    ''                                                                                                       
	...
	''
	AS totalhoraprofesor,
	
	(HORASMES_EPL * 12) as horasAnuales,
    ...
    AS sexo,
    sexo_epl,
    fechaingreso_epl, FECHASALIDA_EPL,
    ''                                                                                                       
    AS fechaingresoinstitucion,
	''                                                                                                       
    AS	fechasalidainstitucion,
    concat_ws('|',catprof_epl)                                                             
    AS catprof_epl,
	formaContrato_epl,
    nombre_fac,
    ''                                                                                                       
...
if($arrMain){
	...
	for($i=0;$i<$totAll;$i++){	
		...
		if($arrMain[$i]['FECHASALIDA_EPL']<>'0000-00-00'){
			$arrMain[$i]['fechasalidainstitucion'] = strftime("%d/%m/%Y",strtotime($arrMain[$i]['FECHASALIDA_EPL']));
		}
		...
		$limite=' 0,1';
//		for()
		$arrForm = formacionProf($arrMain[$i]['serial_epl'],"TERCER NIVEL",$dblink,$limite);
		if($arrForm<>-1){
			...
			if($arrForm['nivel'] == "III DOCTOR EN JURISPRUDENCIA O FILOSOFIA"){
				$arrMain[$i]['nivel_tn1'] = "DOCTOR EN FILOSOFIA O JURISPRUDENCIA";
			}else{
				$arrMain[$i]['nivel_tn1'] = $arrForm['nivel'];
			}
			$arrMain[$i]['titulo_tn1'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_tn1'] = $arrForm['institucion'];
			$arrMain[$i]['fechafin_foaT1'] = $arrForm['fecha'];			
			$arrMain[$i]['pais_tn1'] = strtoupper($arrForm['pais']);
			$arrMain[$i]['unescoT1'] = $arrForm['subunesco'];			
			//quit
			//$arrMain[$i]['nivel_tn'] = $arrForm['nivel'];
			$arrMain[$i]['registro_tn1'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_tn1'] = "NO APLICA";
			$arrMain[$i]['institucion_tn1'] = "NO APLICA";
			$arrMain[$i]['fechafin_foaT1'] = "";			
			$arrMain[$i]['nivel_tn1'] = "NINGUNO";
			$arrMain[$i]['pais_tn1'] = "NO APLICA";
			$arrMain[$i]['registro_tn1'] = "NO APLICA";	
			$arrMain[$i]['unescoT1'] = "NO APLICA";	
		}
		//Tercer Nivel 2
		$limite=' 1,1';
//		for()
		...
		if($arrForm<>-1){
			...
			//if($arrForm['nivel'] == "III DOCTOR EN JURISPRUDENCIA O FILOSOFIA" or $arrForm['nivel'] == "IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"){
			if($arrForm['nivel'] == "III DOCTOR EN JURISPRUDENCIA O FILOSOFIA"){
				$arrMain[$i]['nivel_tn2'] = "DOCTOR EN FILOSOFIA O JURISPRUDENCIA";
			}else{
				$arrMain[$i]['nivel_tn2'] = $arrForm['nivel'];
			}
			$arrMain[$i]['titulo_tn2'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_tn2'] = $arrForm['institucion'];
			$arrMain[$i]['fechafin_foaT2'] = $arrForm['fecha'];			
			$arrMain[$i]['pais_tn2'] = strtoupper($arrForm['pais']);
			$arrMain[$i]['unescoT2'] = $arrForm['subunesco'];			
			//quit
			//$arrMain[$i]['nivel_tn'] = $arrForm['nivel'];
			$arrMain[$i]['registro_tn2'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_tn2'] = "NO APLICA";
			$arrMain[$i]['institucion_tn2'] = "NO APLICA";
			$arrMain[$i]['fechafin_foaT2'] = "";			
			$arrMain[$i]['nivel_tn2'] = "NINGUNO";
			$arrMain[$i]['pais_tn2'] = "NO APLICA";
			$arrMain[$i]['registro_tn2'] = "NO APLICA";	
			$arrMain[$i]['unescoT2'] = "NO APLICA";	
		}
		//Tercer Nivel 3
		$limite=' 2,1';
//		for()
		...
		if($arrForm<>-1){
			...
			//if($arrForm['nivel'] == "III DOCTOR EN JURISPRUDENCIA O FILOSOFIA" or $arrForm['nivel'] == "IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"){
			if($arrForm['nivel'] == "III DOCTOR EN JURISPRUDENCIA O FILOSOFIA"){
				$arrMain[$i]['nivel_tn3'] = "DOCTOR EN FILOSOFIA O JURISPRUDENCIA";
			}else{
				$arrMain[$i]['nivel_tn3'] = $arrForm['nivel'];
			}
			$arrMain[$i]['titulo_tn3'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_tn3'] = $arrForm['institucion'];
			$arrMain[$i]['fechafin_foaT3'] = $arrForm['fecha'];			
			$arrMain[$i]['pais_tn3'] = strtoupper($arrForm['pais']);
			$arrMain[$i]['unescoT3'] = $arrForm['subunesco'];			
			//quit
			//$arrMain[$i]['nivel_tn'] = $arrForm['nivel'];
			$arrMain[$i]['registro_tn3'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_tn3'] = "NO APLICA";
			$arrMain[$i]['institucion_tn3'] = "NO APLICA";
			$arrMain[$i]['fechafin_foaT3'] = "";			
			$arrMain[$i]['nivel_tn3'] = "NINGUNO";
			$arrMain[$i]['pais_tn3'] = "NO APLICA";
			$arrMain[$i]['registro_tn3'] = "NO APLICA";	
			$arrMain[$i]['unescoT3'] = "NO APLICA";	
		}


		//Cuarto Nivel 1
		$limite=' 0,1';
		$arrForm = formacionProf($arrMain[$i]['serial_epl'],"CUARTO NIVEL",$dblink,$limite);
		if($arrForm<>-1){
		//echo " ".$arrForm['nivel'];
			switch($arrForm['nivel']){
				case "DIPLOMADO":
						$arrMain[$i]['nivel_cn1'] = "DIPLOMA SUPERIOR";	
					break;
				case "MAGISTER":	
						$arrMain[$i]['nivel_cn1'] = "MAGISTER";	
					break;
				case "DOCTORADO":	
						$arrMain[$i]['nivel_cn1'] = "DOCTOR PH.D";	
					break;				
				...
				default: $arrMain[$i]['nivel_cn1'] = $arrForm['nivel'];			
			}
			$arrMain[$i]['titulo_cn1'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_cn1'] = $arrForm['institucion'];
			//if($arrMain[$i]['titulo_tn']<>"NO APLICA"){
			$arrMain[$i]['fechafin_foaC1'] = $arrForm['fecha'];
			$arrMain[$i]['unescoC1'] = $arrForm['subunesco'];			
			//}
			//quit
			//$arrMain[$i]['nivel_cn'] = $arrForm['nivel'];						
			$arrMain[$i]['pais_cn1'] =strtoupper($arrForm['pais']);
			$arrMain[$i]['registro_cn1'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_cn1'] = "NO APLICA";
			$arrMain[$i]['institucion_cn1'] = "NO APLICA";
			$arrMain[$i]['nivel_cn1'] = "NINGUNO";
			if($arrMain[$i]['titulo_cn1']=="NO APLICA"){
				$arrMain[$i]['fechafin_foaC1'] = "";
			}
			$arrMain[$i]['pais_cn1'] = "NO APLICA";
			$arrMain[$i]['registro_cn1'] = "NO APLICA";		
			$arrMain[$i]['unescoC1'] = "NO APLICA";
		}
		...
		if($arrForm<>-1){
			switch($arrForm['nivel']){
				case "DIPLOMADO":
						$arrMain[$i]['nivel_cn2'] = "DIPLOMA SUPERIOR";	
					break;
				case "MAGISTER":	
						$arrMain[$i]['nivel_cn2'] = "MAGISTER";	
					break;
				case "DOCTORADO":	
						$arrMain[$i]['nivel_cn2'] = "DOCTOR PH.D";	
					break;				
				case "IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA":	
						$arrMain[$i]['nivel_cn2'] = "MAGISTER";	
				break;		
				default: $arrMain[$i]['nivel_cn2'] = $arrForm['nivel'];			
			}
			$arrMain[$i]['titulo_cn2'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_cn2'] = $arrForm['institucion'];
			//if($arrMain[$i]['titulo_tn']<>"NO APLICA"){
			$arrMain[$i]['fechafin_foaC2'] = $arrForm['fecha'];
			$arrMain[$i]['unescoC2'] = $arrForm['subunesco'];			
			//}
			//quit
			//$arrMain[$i]['nivel_cn'] = $arrForm['nivel'];						
			$arrMain[$i]['pais_cn2'] =strtoupper($arrForm['pais']);
			$arrMain[$i]['registro_cn2'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_cn2'] = "NO APLICA";
			$arrMain[$i]['institucion_cn2'] = "NO APLICA";
			$arrMain[$i]['nivel_cn2'] = "NINGUNO";
			if($arrMain[$i]['titulo_cn2']=="NO APLICA"){
				$arrMain[$i]['fechafin_foaC2'] = "";
			}
			$arrMain[$i]['pais_cn2'] = "NO APLICA";
			$arrMain[$i]['registro_cn2'] = "NO APLICA";	
			$arrMain[$i]['unescoC2'] = "NO APLICA";	
		}
		...
		if($arrForm<>-1){
			switch($arrForm['nivel']){
				case "DIPLOMADO":
						$arrMain[$i]['nivel_cn3'] = "DIPLOMA SUPERIOR";	
					break;
				case "MAGISTER":	
						$arrMain[$i]['nivel_cn3'] = "MAGISTER";	
					break;
				case "DOCTORADO":	
						$arrMain[$i]['nivel_cn3'] = "DOCTOR PH.D";	
					break;			
				
				case "IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA":	
						$arrMain[$i]['nivel_cn3'] = "MAGISTER";	
					break;			
				default: $arrMain[$i]['nivel_cn3'] = $arrForm['nivel'];			
			}
			$arrMain[$i]['titulo_cn3'] = $arrForm['titulo'];
			$arrMain[$i]['institucion_cn3'] = $arrForm['institucion'];
			//if($arrMain[$i]['titulo_tn']<>"NO APLICA"){
			$arrMain[$i]['fechafin_foaC3'] = $arrForm['fecha'];
			$arrMain[$i]['unescoC3'] = $arrForm['subunesco'];			
			//}
			//quit
			//$arrMain[$i]['nivel_cn'] = $arrForm['nivel'];						
			$arrMain[$i]['pais_cn3'] =strtoupper($arrForm['pais']);
			$arrMain[$i]['registro_cn3'] = $arrForm['registro'];
		}else{
			$arrMain[$i]['titulo_cn3'] = "NO APLICA";
			$arrMain[$i]['institucion_cn3'] = "NO APLICA";
			$arrMain[$i]['nivel_cn3'] = "NINGUNO";
			if($arrMain[$i]['titulo_cn3']=="NO APLICA"){
				$arrMain[$i]['fechafin_foaC3'] = "";
			}
			$arrMain[$i]['pais_cn3'] = "NO APLICA";
			$arrMain[$i]['registro_cn3'] = "NO APLICA";
			$arrMain[$i]['unescoC3'] = "NO APLICA";		
		}
		...
		if($arrHoraAcademica){			
			...
			//echo "</p>".$arrMain[$i]['totalhoraprofesor']." ---- ".$arrMain[$i]['serial_epl'];
		...
		switch($arrMain[$i]['formaContrato_epl']){				
				case "TIEMPO COMPLETO":
					$arrMain[$i]['horadedicacion'] = $arrMain[$i]['horasDia_epl']*5;				
					break;
				case "TIEMPO PARCIAL":
					$arrMain[$i]['horadedicacion'] = $arrMain[$i]['horasDia_epl']*5;
					break;
				case "TIEMPO POR HORAS":	
					$arrMain[$i]['horadedicacion'] =  $arrMain[$i]['horaacademica'];
					break;
		...
		$arrMain[$i]['horaadministrativa']=$arrMain[$i]['horadedicacion']-($arrMain[$i]['numero_horas_materia']+$arrMain[$i]['horainvestigacion'] +$arrMain[$i]['horavinculacion']);
		...
		//Set Email      EMAILUNIV_EPL
		if(trim($arrMain[$i]['EMAILUNIV_EPL'])!=""){
			$arrMain[$i]['EMAILUNIV_EPL'] = $arrMain[$i]['EMAILUNIV_EPL'];		
		}else{
			if(trim($arrMain[$i]['email_epl'])!=""){
				$arrMain[$i]['EMAILUNIV_EPL'] = $arrMain[$i]['email_epl'];		
			}else{
				$arrMain[$i]['EMAILUNIV_EPL'] = "";		
			}
			
		}
		//Set Materias Dictadas
		
		//echo "<br>SQLGET: ".$nomMateria[0][1]."<br>";
		
		//Set Materia con mas horas y Promedio de horas Materia
		$arrMasHoras = getMatMasHoras($arrMain[$i]['serial_epl'],$serial_sec,$fecha_ini,$fecha_fin,$dblink);
		if($arrMasHoras){
...
<a name="inicio"></a>
        ...
        <table id="tablequick" summary="Profesores PEI" >
          ...
          <thead>
            <tr>
              <th scope="col">SERIAL_EPL</th>
              <th scope="col">Institucion(no existe)</th>
              <th scope="col">cadigo_campus</th>
              <th scope="col">campus</th>
              <th scope="col">tipo_personal_ies </th>
              ...
              <th scope="col">numero_carnet_conadis </th>
              <th scope="col">porcentaje_discapacidad </th>
              <th scope="col">email_personal </th>
              <th scope="col">nivel_ultimo_titulo_tercer_nivel </th>
              <th scope="col">ultimo_titulo_tercer_nivel</th>
              <th scope="col">fecha_ultimo_TITULO_tercer_nivel </th>
              <th scope="col">universidad_ultimo_titulo_tn </th>
              <th scope="col">pais_ultimo_titulo_tn</th>
              <th scope="col">registro_senescyt_titulo_tn</th>
              <th scope="col">subarea_ultimo_titulo_tn</th>
              <th scope="col">nivel_penultimo_titulo_tn </th>
              <th scope="col">penultimo_titulo_tn </th>
              <th scope="col">fecha_penultimo_titulo_tn </th>
              <th scope="col">universidad_penultimo_titulo_tn </th>
              <th scope="col">pais_penultimo_titulo_tn </th>
              <th scope="col">registro_senesct_penultimo_titulo_tn </th>
              <th scope="col">subarea_penultimo_titulo_tn </th>
              <th scope="col">nivel_antepenultimo_titulo_tn </th>
              <th scope="col">antepenultimo_Titulo_tn </th>
              <th scope="col">fecha_antepenultimo_titulo_tn </th>
              <th scope="col">universidad_antepenultimo_titulo_tn </th>
              <th scope="col">pais_antepenulrimo_titulo_tn </th>
              <th scope="col">registro_senescyt_antepenultimo_titulo_tn </th>
              <th scope="col">subarea_antepenultimo_titulo_tn </th>
              <th scope="col">nivel_ultimo_titulo_cn </th>
              <th scope="col">ultimo_TITULO_CN</th>
              <th scope="col">fecha_ultimo_titulo_cn </th>
              <th scope="col">universidad_ultimo_titulo_cn </th>
              <th scope="col">pais_ultimo_titulo_cn </th>
              <th scope="col">registro_senescyt_ultimo_cn </th>
              <th scope="col">subarea_ultimo_titulo_cn</th>
              <th scope="col">nivel_penultimo_titulo_cn </th>
              <th scope="col">penultimo_titulo_cn </th>
              <th scope="col">fecha_penultimo_titulo_cn</th>
              <th scope="col">universidad_penultimo_titulo_cn </th>
              <th scope="col">pais_penultimo_titulo_cn</th>
              <th scope="col">REGISTRO_SENESCYT_penultimo_TITULO_CN</th>
              <th scope="col">subarea_penultimo_titulo_cn</th>
              <th scope="col">NIVEL_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">TITULO_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">FECHA_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">UNIVERSIDAD_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">PAIS_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">REGISTRO_SENSCYT_ANTEPENULTIMO_TITULO_CN </th>
              <th scope="col">SUBAREA_antepenultimo_TITULO_cn</th>
              <th scope="col">NUMERO_NOMBRAMIENTO_CONTRATO </th>
              <th scope="col">FECHA_INGRESO_IES</th>
              <th scope="col">RELACION_TRABAJO_IES</th>
              <th scope="col">INGRESO_CONCURSO </th>
              <th scope="col"> CARGO_CONTRATO_NOMBRAMIENTO </th>
              <th scope="col">HORAS_LABORADAS_ANUALES </th>
              <th scope="col">REMUNERACION_ANUAL </th>
              <th scope="col">FECHA_SALIDA_IES </th>
              <th scope="col"><span class="style1 style3">docencia_tercer_nivel </span></th>
              <th scope="col"><span class="style1 style3">docencia_cn </span></th>
              <th scope="col">CODIGO_ASIGNATURA_DICTA_1 </th>
              <th scope="col">ASIGNATURA_DICTA_1 </th>
              <th scope="col">NUMERO_HORAS_ASIGNATURA_1 </th>
              <th scope="col">CODIGO_ASIGNATURA_DICTA_2 </th>
              <th scope="col">ASIGNATURA_DICTA_2 </th>
              <th scope="col">NUMERO_HORAS_ASIGNATURA_2 </th>
              <th scope="col">CODIGO_ASIGNATURA_DICTA_3 </th>
              <th scope="col">ASIGNATURA_DICTA_3 </th>
              <th scope="col">NUMERO_HORAS_ASIGNATURA_3 </th>
              <th scope="col">CODIGO_ASIGNATURA_DICTA_4 </th>
              <th scope="col">ASIGNATURA_DICTA_4 </th>
              <th scope="col">NUMERO_HORAS_ASIGNATURA_4 </th>
              <th scope="col">CODIGO_ASIGNATURA_DICTA_5 </th>
              <th scope="col">ASIGNATURA_DICTA_5 </th>
              <th scope="col">NUMERO_HORAS_ASIGNATURA_5 </th>
              <th scope="col">CARGO_AUTORIDAD </th>
              <th scope="col">FECHA_INICIO_CARGO_AUTORIDAD </th>
              <th scope="col">FECHA_FIN_CARGO_AUTORIDAD </th>
              <th scope="col">NUMERO_DOCUEMENTO_CARGO_AUTORIDAD </th>
              <th scope="col"><p>CATEGORIA_PERSONAL_ACADEMICO</p></th>
              <th scope="col">tiempo_dedicacion </th>
              <th scope="col">UNIDAD_ACADEMICA</th>
              <th scope="col">Horas_docencia</th>
              <th scope="col">HORAS_INVESTIGacion</th>
              <th scope="col">HORAS_ADMINISTrativas</th>
              <th scope="col">HORAS_Vinculacion_Sociedad</th>
              <th scope="col">autoevaluacion</th>
              <th scope="col">coevaluacion_pares </th>
              <th scope="col">coevaluacion_directivos </th>
              <th scope="col">heteroevaluacion</th>
              <th scope="col">numero_cursos_nacionales </th>
              <th scope="col">numero_cursos_internacionales </th>
              <th scope="col">numero_cursos_metodologia </th>
              <th scope="col">cursando_estudios </th>
              <th scope="col">financiamiento_estudios_php </th>
              <th scope="col">PERIODO_SABATICO</th>
              <th scope="col">fecha_inicio_sabatico </th>
              <th scope="col">fecha_fin_sabatico </th>
              <th scope="col">nombre_libro_publicado_personal_academico_1 </th>
              <th scope="col">anio_publicacion_libro 1 </th>
              <th scope="col">particion libro 1</th>
              <th scope="col">revision libro pares 1</th>
              <th scope="col">numero_isbn_1 </th>
              <th scope="col">nombre libro publicado personal academico 2 </th>
              <th scope="col">anio de publicacion libro 2 </th>
              <th scope="col">particion libro 2 </th>
              <th scope="col">revision libro pares 2 </th>
              <th scope="col">numero isbn 2 </th>
              <th scope="col">nombre articulo 1 </th>
              <th scope="col">nombre de la revista publicado personal academico 1 </th>
              <th scope="col">anio publicacion articulo 1 </th>
              <th scope="col">participacion articulo 1 </th>
              <th scope="col">estado de publicacion 1 </th>
              <th scope="col">revista indexada publicacion articulo 1 </th>
              <th scope="col">base de datos revista indexada 1 </th>
              <th scope="col">nombre articulo 2 </th>
              <th scope="col">nombre revista articulo publicaado personal academico 2 </th>
              <th scope="col">anio publicacion articulo 2 </th>
              <th scope="col">participacion articulo 2 </th>
              <th scope="col">estado publicacion 2 </th>
              <th scope="col">revista indexada publicacion articulo 2 </th>
              <th scope="col">base de datos revista indexada 2 </th>
              <th scope="col">movilidad ies extranjeras </th>
              <th scope="col">movilidad ies nacionales </th>
              <th scope="col">sistema_registro_consultas_academicas </th>
              <th scope="col">correo electronico institucional </th>
              <th scope="col">servicio de biblioteca virtual </th>
              <th scope="col">plataforma de enseñanza virtual </th>
              <th scope="col">email institucional </th>
              <th scope="col">OBSERVACIONES</th>
              <th scope="col"><span class="style1">MATERIA_MAYOR_HORAS </span></th>
              <th scope="col"><span class="style1">NUMERO_HORAS_MATERIA </span></th>
              <th scope="col"><span class="style1">CATEGORIA_UBICACION </span></th>
              <th scope="col"><span class="style1">SUELDO_2011 </span></th>
              <th scope="col"><span class="style1">DEDICACION</span></th>
              <th scope="col"><span class="style1">SIST_EVAL_DOCENTE</span></th>
              <th scope="col"><span class="style1">PART_EVENT_ACADEMICOS</span></th>
              <th scope="col"><span class="style1">AUSPICIO_SEMINARIO </span></th>
              <th scope="col"><span class="style1">AFILACION_ASOCIACION </span></th>
              <th scope="col"><span class="style1">BENEFICIO_ASCENSO </span></th>
              <th scope="col"><span class="style1"></span></th>
              <th scope="col"><span class="style1">ACAD_EXTRANJERO</span></th>
              <th scope="col"><span class="style1">INVESTIGADOR_PERM</span></th>
              <th scope="col"><span class="style1">INVESTIGADOR_ESP</span></th>
              <th scope="col"><span class="style2">PUBLICACION_R_INTERNACIONALES_INDEXADAS</span></th>
              <th scope="col"><span class="style1">UBLICACION_R_INTERNACIONALES_NO_INDEXADAS</span></th>
              <th scope="col"><span class="style1">PUBLICACION_R_NACIONALES_INDEXADAS </span></th>
              <th scope="col"><span class="style1">PUBLICACION_R_NACIONALES_NO_INDEXADAS </span></th>
              <th scope="col"><span class="style1">NUMERO_LIBROS_PUBLICADOS_SIN_ISBN </span></th>
              <th scope="col">&nbsp;</th>
              <th scope="col">&nbsp;</th>
              <th scope="col"><span class="style1">EMAIL</span></th>
              <th scope="col"><span class="style1">FECHA_TITULO </span></th>
              <th scope="col"><span class="style1">FORMA CONTRATO </span></th>
              <th scope="col"><span class="style1">HORA REAL </span></th>
          ...
          <tfoot>
            <tr>
              ...
              <td colspan="173"><?php echo $totAll." PROFESORES";?></td>
            </tr>
          </tfoot>
          <tbody>
            <?php
		 $sql="DELETE FROM auxiliar_pei";// borrar el contenido de la tabla
		 $dblink->Execute($sql); // ejecutar la consulta
			...
			switch($arrMain[$i]['nombre_tct']){
				case 'Contrato por Tiempo Indefinido': 						
						$arrMain[$i]['nombre_tct']='NOMBRAMIENTO O CONTRATO INDEFINIDO';
						break;
				case 'NOMBRAMIENTO':
						$arrMain[$i]['nombre_tct']='NOMBRAMIENTO O CONTRATO INDEFINIDO';
						break;								
			...
			if($arrMain[$i]['cargo']=='DOCENTE INVESTIGADOR')
				$cargoTipoPersonal='PROFESOR / INVESTIGADOR';			
			else
				$cargoTipoPersonal='PROFESOR';
				
			////////////////// Discapacidad Empleado///////////
		$discapacidadEpl=getDiscapacidad($arrMain[$i]['serial_epl'],$dblink);
		$tipo_disepl=$discapacidadEpl[0];
		$carnet_conadis_disepl=$discapacidadEpl[1];
		$num_carnet_dispel=$discapacidadEpl[2];
		$porcentaje_disepl=$discapacidadEpl[3];
		
		//// Periodo Sabatico 
		$periodosabatico=getPeridoSabatico($arrMain[$i]['serial_epl'],$dblink);
		$periodo_psa=$periodosabatico[0];
		$fecha_inicio_psa=$periodosabatico[1];
		$fecha_fin_psa=$periodosabatico[2];
		//// metodologia y lugar de capacitacion 
		$lugarCapcitacion=getLugarcap($arrMain[$i]['serial_epl'],$dblink);
		$CursoNacional= $lugarCapcitacion[0];
		$cursoInternacional=$lugarCapcitacion[1];
		$cursosMetodologia=$lugarCapcitacion[2];
		
		//// Cursando estudios
		$cursandoEstudio=getEstudios($arrMain[$i]['serial_epl'],1,$dblink);
		
		$FinanciamientoPhD=getEstudios($arrMain[$i]['serial_epl'],2,$dblink);
		
				
		//////////////////INFORMACION MATERIAS//////////////////////////		
		$arrMatDict = getMatDictProfesor($arrMain[$i]['serial_epl'],$serial_sec,$fecha_ini,$fecha_fin,$dblink);
		
		if($arrMatDict){
			$nomMateria=$arrMatDict[0];
			$codMateria=$arrMatDict[1];
			$horMateria=$arrMatDict[2];
		}else{
			$nomMateria = '';
		}	
		...
		/////////////////publicaciones//////////////////////////
		$arrPublicacionesLibros = getPublicaciones($arrMain[$i]['serial_epl'],2,$fecha_ini,$fecha_fin,$dblink);
		
		$nomPubliLibro=$arrPublicacionesLibros[0];
		//echo "fffsfsdfsf ".$nomPubliLibro;
		$anioPubliLibro=$arrPublicacionesLibros[1];
		$participacion_pbl1=$arrPublicacionesLibros[2];
		$numero_ISBN_pbl=$arrPublicacionesLibros[3];
		$revision_pbl=$arrPublicacionesLibros[4];
				
			
		$arrPublicacionesArticulos = getPublicaciones($arrMain[$i]['serial_epl'],1,$fecha_ini,$fecha_fin,$dblink);		
		$nomPubliArticulos=$arrPublicacionesArticulos[0];
		$nombre_revista_articulo_pbl=$arrPublicacionesArticulos[1];
		$anioPubliArticulos=$arrPublicacionesArticulos[2];
		$participacion_pbl=$arrPublicacionesArticulos[3];
		$estado_pbl=$arrPublicacionesArticulos[4];
		$revista_indexada_articulo_pbl=$arrPublicacionesArticulos[5];
		$basedatos_revista_indexada_pbl=$arrPublicacionesArticulos[6];		
			//////////////REMUNERACION ANUAL/////////////////////
			
			$sueldo_anual=sueldoHoras($arrMain[$i]['serial_epl'],$dblink);
			
			$clasesPostPre=clasesPostPre($arrMain[$i]['serial_epl'],$dblink);	
			$docenciaTN=$clasesPostPre[0];
			$docenciaCN=$clasesPostPre[1];
		
		
		?>
            <tr<?php echo $class;//?>>
              <td><?php echo $arrMain[$i]['serial_epl']?></td>
              <th scope="row" id="<?php echo "r".$i+1;?>"><a href="#" class="style1" > <?php echo $arrMain[$i]['codigo_institucion']; 	 
			   ?> </a></th>
              <td><?php echo $codigocampus;?> </td>
              <td><?php echo $nombreCampus;?></td>
              <td><?php echo $cargoTipoPersonal;?></td>
              <td><a href="#"><?php echo $arrMain[$i]['provincia']?></a></td>
              <td><?php echo $arrMain[$i]['canton']?></td>
              <td><?php echo $arrMain[$i]['parroquia']?></td>
              <td><?php echo $arrMain[$i]['direccion_suc']?></td>
              <td><?php echo $arrMain[$i]['TIPODOCUMENTO_EPL'];?></td>
              ...
              <td><?php echo $tipo_disepl[0]; ?></td>
              <td><?php echo $carnet_conadis_disepl[0]; ?></td>
              <td><?php echo $num_carnet_dispel[0]; ?></td>
              <td><?php echo $porcentaje_disepl[0]; ?></td>
              <td><?php echo strtolower($arrMain[$i]['email_epl']); ?></td>
              <td><?php echo $arrMain[$i]['nivel_tn1'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_tn1'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaT1']; ?></td>
              <td><?php echo $arrMain[$i]['institucion_tn1'] ?></td>
              <td><?php echo $arrMain[$i]['pais_tn1'] ?></td>
              <td><?php echo $arrMain[$i]['registro_tn1'] ?></td>
              <td><?php echo $arrMain[$i]['unescoT1'];?></td>
              <td><?php echo $arrMain[$i]['nivel_tn2'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_tn2'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaT2']; ?></td>
              <td><?php echo $arrMain[$i]['institucion_tn2'] ?></td>
              <td><?php echo $arrMain[$i]['pais_tn2'] ?></td>
              <td><?php echo $arrMain[$i]['registro_tn2'] ?></td>
              <td><?php echo $arrMain[$i]['unescoT2'];?></td>
              <td><?php echo $arrMain[$i]['nivel_tn3'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_tn3'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaT3']; ?></td>
              <td><?php echo $arrMain[$i]['institucion_tn3'] ?></td>
              <td><?php echo $arrMain[$i]['pais_tn3'] ?></td>
              <td><?php echo $arrMain[$i]['registro_tn3'] ?></td>
              <td><?php echo $arrMain[$i]['unescoT3'];?></td>
              <td><?php echo $arrMain[$i]['nivel_cn1'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_cn1'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaC1'];?></td>
              <td><?php echo $arrMain[$i]['institucion_cn1'] ?></td>
              <td><?php echo $arrMain[$i]['pais_cn1'] ?></td>
              <td><?php echo $arrMain[$i]['registro_cn1'] ?></td>
              <td><?php echo $arrMain[$i]['unescoC1'] ?></td>
              <td><?php echo $arrMain[$i]['nivel_cn2'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_cn2'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaC2'];?></td>
              <td><?php echo $arrMain[$i]['institucion_cn2'] ?></td>
              <td><?php echo $arrMain[$i]['pais_cn2'] ?></td>
              <td><?php echo $arrMain[$i]['registro_cn2'] ?></td>
              <td><?php echo $arrMain[$i]['unescoC2'] ?></td>
              <td><?php echo $arrMain[$i]['nivel_cn3'] ?></td>
              <td><?php echo $arrMain[$i]['titulo_cn3'] ?></td>
              <td><?php echo $arrMain[$i]['fechafin_foaC3'];?></td>
              <td><?php echo $arrMain[$i]['institucion_cn3'] ?></td>
              <td><?php echo $arrMain[$i]['pais_cn3'] ?></td>
              <td><?php echo $arrMain[$i]['registro_cn3'] ?></td>
              <td><?php echo $arrMain[$i]['unescoC3'] ?></td>
              <!--<td><span class="style2"><?php echo $arrMain[$i]['unesco'] ?></span></td>-->
              <td><?php echo $arrMain[$i]['NumNombramientoContrato_epl']; ?></td>
              <td><?php echo $arrMain[$i]['fechaingresoinstitucion']; ?></td>
              <td><?php echo strtoupper($arrMain[$i]['nombre_tct']); ?></td>
              <td><?php echo "NO";?></td>
              <td><?php echo $arrMain[$i]['cargoadm_epl']; ?></td>
              <td><?php /*echo "&nbsp;";*//*echo $arrMain[$i]['nombre_nac']*/echo $arrMain[$i]['formaContrato_epl']." / ".$arrMain[$i]['horaacademicaant']." / ".$arrMain[$i]['tothoraobs'];?>
                (revisar) </td>
              <td><?php echo $sueldo_anual;?></td>
              <td><?php echo $arrMain[$i]['fechasalidainstitucion'] ?></td>
              <td><?php echo $docenciaTN;?></td>
              <td><?php echo $docenciaCN;?></td>
              <td><?php echo $codMateria[0]; ?></td>
              <td><?php echo $nomMateria[0]; ?></td>
              <td><?php echo $horMateria[0]; ?></td>
              <td><?php echo $codMateria[1]; ?></td>
              <td><?php echo $nomMateria[1]; ?></td>
              <td><?php echo $horMateria[1]; ?></td>
              <td><?php echo $codMateria[2]; ?></td>
              <td><?php echo $nomMateria[2]; ?></td>
              <td><?php echo $horMateria[2]; ?></td>
              <td><?php echo $codMateria[3]; ?></td>
              <td><?php echo $nomMateria[3]; ?></td>
              <td><?php echo $horMateria[3]; ?></td>
              <td><?php echo $codMateria[4]; ?></td>
              <td><?php echo $nomMateria[4]; ?></td>
              <td><?php echo $horMateria[4]; ?></td>
              <td><?php echo $arrMain[$i]['cargoaut_epl']; ?></td>
              <td><?php echo $arrMain[$i]['fecha_inicio_aut_epl']; ?></td>
              <td><?php echo $arrMain[$i]['fechaFinCargoAut_epl']; ?></td>
              <td><?php echo $arrMain[$i]['NumDocumCargoAut_epl']; ?></td>
              <td><?php echo $arrMain[$i]['catprof_epl']; ?></td>
              <td><?php echo $arrMain[$i]['formaContrato_epl'];?></td>
              <td><?php echo $arrMain[$i]['unidadacademica'] ;?></td>
              <td><p><?php echo $arrMain[$i]['numero_horas_materia'] ?></p>
                  <p>&nbsp;</p></td>
              ...
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><?php echo $CursoNacional; ?></td>
              <td><?php echo $cursoInternacional; ?></td>
              <td><?php echo $cursosMetodologia; ?></td>
              <td> <?php echo $cursandoEstudio; ?> </td>
              <td><?php echo $FinanciamientoPhD; ?></td>
              <td><?php echo $periodo_psa[0] ?></td>
              <td><?php echo $fecha_inicio_psa[0] ?></td>
              <td><?php echo $fecha_fin_psa[0] ?></td>
			  
              <td><?php if($nomPubliLibro[0]=='')echo 'NO APLICA';
			  			else echo $nomPubliLibro[0] ?></td>
						
              <td><?php if($anioPubliLibro[0]=='')echo '0';
			  			else echo $anioPubliLibro[0] ?></td>
						
              <td><?php if($participacion_pbl1[0]=='')echo 'NINGUNO';
			  			else echo $participacion_pbl1[0] ?></td>
						
              <td><?php if($revision_pbl[0]=='')echo 'NO';
			  			else echo $revision_pbl[0]  ?></td>
						
			<td><?php  if($numero_ISBN_pbl[0]=='')echo '0';
			  			else echo $numero_ISBN_pbl[0] ?></td>
									
			 <td><?php if($nomPubliLibro[1]=='')echo 'NO APLICA';
			  			else echo $nomPubliLibro[1] ?></td>
						
              <td><?php if($anioPubliLibro[1]=='')echo '0';
			  			else echo $anioPubliLibro[1] ?></td>
						
              <td><?php if($participacion_pbl1[1]=='')echo 'NINGUNO';
			  			else echo $participacion_pbl1[1] ?></td>
						
              <td><?php if($revision_pbl[1]=='')echo 'NO';
			  			else echo $revision_pbl[1]  ?></td>
						
			<td><?php  if($numero_ISBN_pbl[1]=='')echo '0';
			  			else echo $numero_ISBN_pbl[1] ?></td>
						
						<!-- revista-->
              <td><?php  if($nomPubliArticulos[0]=='')echo 'NO APLICA';
			  			else echo $nomPubliArticulos[0]?></td>
			  
			  <td><?php if($nombre_revista_articulo_pbl[0]=='')echo 'NO APLICA';
			  			else echo $nombre_revista_articulo_pbl[0]?></td>
		
              <td><?php if($anioPubliArticulos[0]=='')echo '0';
			  			else echo $anioPubliArticulos[0]?></td>
						
              <td><?php if($participacion_pbl[0]=='')echo 'NINGUNO';
			  			else echo $participacion_pbl[0]?></td>
						
              <td><?php if($estado_pbl[0]=='')echo 'NINGUNO';
			  			else echo $estado_pbl[0]?></td>
						
              <td><?php  if($revista_indexada_articulo_pbl[0]=='')echo 'NO';
			  			else echo $revista_indexada_articulo_pbl[0] ?></td>
						
              <td><?php  if($basedatos_revista_indexada_pbl[0]=='')echo 'NO';
			  			else echo $basedatos_revista_indexada_pbl[0] ?></td>
			  
			   <td><?php  if($nomPubliArticulos[1]=='')echo 'NO APLICA';
			  			else echo $nomPubliArticulos[1]?></td>
			  
			  <td><?php if($nombre_revista_articulo_pbl[1]=='')echo 'NO APLICA';
			  			else echo $nombre_revista_articulo_pbl[1]?></td>
		
              <td><?php if($anioPubliArticulos[1]=='')echo '0';
			  			else echo $anioPubliArticulos[1]?></td>
						
              <td><?php if($participacion_pbl[1]=='')echo 'NINGUNO';
			  			else echo $participacion_pbl[1]?></td>
						
              <td><?php if($estado_pbl[1]=='')echo 'NINGUNO';
			  			else echo $estado_pbl[1]?></td>
						
              <td><?php  if($revista_indexada_articulo_pbl[1]=='')echo 'NO';
			  			else echo $revista_indexada_articulo_pbl[1] ?></td>
						
              <td><?php  if($basedatos_revista_indexada_pbl[1]=='')echo 'NO';
			  			else echo $basedatos_revista_indexada_pbl[1] ?></td>
              ...
              <td>SI</td>
              <td>SI</td>
              <td><?php echo strtolower($arrMain[$i]['EMAILUNIV_EPL']); ?></td>
              <td></td>
              <td>&nbsp;</td>
              ...
              <?php 
//echo $i."-";
$insert="insert into auxiliar_pei(serial_epl, provincia, canton, parroquia, direccion_suc, documentoidentidad_epl, apellido_paterno, apellido_materno, nombre_epl, sexo, nacionalidad, fechanacimiento, titulo_tn, institucion_tn, nivel_tn, pais_tn, registro_tn,titulo_cn, institucion_cn, nivel_cn, pais_cn, registro_cn, unesco, matdict, matmashoras, numero_horas_materia, fechaingresoinstitucion, nombre_tct, cargoadm_epl, cargoaut_epl, catprof_epl, horadedicacionround, nombre_suc, horaacademica,      horaadministrativa, horainvestigacion, horavinculacion, sistevaldocente, eventoacademico, periodosabatico, academicoextranjero, investigadorpermanente, investigadoresporadico, PII, PINI, PNI, PNNI, PCI, PSI, niveldoctn, niveldoccn, email_epl, fechafin_foa,  formaemptoor,formaContrato_epl, horaacademicaant, totalhoraprofesor) values ( '".($arrMain[$i]['serial_epl'])."','".($arrMain[$i]['provincia'])."', '".($arrMain[$i]['canton'])."','".( $arrMain[$i]['parroquia'])."','".($arrMain[$i]['direccion_suc'])."','".($arrMain[$i]['documentoidentidad_epl'])."','".($arrMain[$i]['apellido_paterno'])."','".($arrMain[$i]['apellido_materno'])."','".($arrMain[$i]['nombre_epl'])."','".($arrMain[$i]['sexo'])."','".($arrMain[$i]['nacionalidad'])."','".( $arrMain[$i]['fechanacimiento'])."','".($arrMain[$i]['titulo_tn'])."','".($arrMain[$i]['institucion_tn'])."','".($arrMain[$i]['nivel_tn'])."','".($arrMain[$i]['pais_tn'])."','".($arrMain[$i]['registro_tn'])."','".$arrMain[$i]['titulo_cn']."','".($arrMain[$i]['institucion_cn'])."','".($arrMain[$i]['nivel_cn'])."','".($arrMain[$i]['pais_cn'])."','".($arrMain[$i]['registro_cn'])."','".($arrMain[$i]['unesco'])."','".($arrMain[$i]['matdict'])."','".($arrMain[$i]['matmashoras'])."','".($arrMain[$i]['numero_horas_materia'])."','".($arrMain[$i]['fechaingresoinstitucion'])."','".($arrMain[$i]['nombre_tct'])."','".($arrMain[$i]['cargoadm_epl'])."','".( $arrMain[$i]['cargoaut_epl'])."','".($arrMain[$i]['catprof_epl'])."','".($arrMain[$i]['horadedicacionround'])."','".($arrMain[$i]['nombre_suc'])."','".( $arrMain[$i]['horaacademica'])."','".($arrMain[$i]['horaadministrativa'])."','".($arrMain[$i]['horainvestigacion'])."','".($arrMain[$i]['horavinculacion'])."','".($arrMain[$i]['sistevaldocente'])."','".($arrMain[$i]['eventoacademico'])."','".($arrMain[$i]['periodosabatico'])."','".($arrMain[$i]['academicoextranjero'])."','".($arrMain[$i]['investigadorpermanente'])."','".($arrMain[$i]['investigadoresporadico'])."','".($arrMain[$i]['PII'])."','".($arrMain[$i]['PINI'])."','".($arrMain[$i]['PNI'])."','".($arrMain[$i]['PNNI'])."','".($arrMain[$i]['PCI'])."','".($arrMain[$i]['PSI'])."','".($arrMain[$i]['niveldoctn'])."','".($arrMain[$i]['niveldoccn'])."','".($arrMain[$i]['EMAILUNIV_EPL'])."','".($arrMain[$i]['fechafin_foa'])."','".($arrMain[$i]['formaContrato_epl']." / ".$arrMain[$i]['horaacademicaant']." / ".$arrMain[$i]['tothoraobs'])."','".($arrMain[$i]['formaContrato_epl'])."','".($arrMain[$i]['horaacademicaant'])."','".($arrMain[$i]['totalhoraprofesor'])."')";
...
function sueldoHoras($serial_epl,$dblink){
	
	$remuneracionAnual = "SELECT
							APELLIDO_EPL,
							SUM(VALOR_DRP) as remuneracion,
							erp.*,
							drp.*,
							rgr.NOMBRE_RGR 
						FROM
							empleado             AS epl,
							empleadorolpagos     AS erp,
							detallerolpagos       AS drp,
							rubrogeneralrolpagos AS rgr 
						WHERE
							epl.SERIAL_EPL=erp.SERIAL_EPL AND
							erp.SERIAL_ERP=drp.SERIAL_ERP AND
							drp.SERIAL_RGR=rgr.SERIAL_RGR AND
							epl.SERIAL_EPL = ".$serial_epl." AND
							rgr.SERIAL_RGR IN (23,	32,	33) AND
							SERIAL_PERROL IN(	SELECT
													SERIAL_PERROL 
												FROM
													periodorol 
												WHERE
													FECHAINICIO_PERROL >='".$GLOBALS['fecha_ini']."' AND
													FECHAINICIO_PERROL <='".$GLOBALS['fecha_fin']."'
							)
						GROUP BY epl.SERIAL_EPL";
							
			//echo 	"</p>".$remuneracionAnual;			

		$rsRemuneracionAnual = $dblink->Execute($remuneracionAnual);
						if($rsRemuneracionAnual->recordCount()>0)
							$remuneracion = $rsRemuneracionAnual->fields['remuneracion'];
						else
							$remuneracion = 0;
...
function clasesPostPre($serial_epl,$dblink){	
	$pregrado = "SELECT
					*
				FROM
					horario AS hrr,
					periodo AS per 
				WHERE
					hrr.SERIAL_PER=per.serial_per AND
					per.serial_sec=1 AND
					SERIAL_EPL=".$serial_epl." 
				and fecini_per >='".$GLOBALS['fecha_ini']."' AND
					fecini_per<='".$GLOBALS['fecha_fin']."' and estado_hrr like 'activo'";
//echo 	"</p>".$pregrado;
		...
		$postgrado = "SELECT
						*
						...
						WHERE
							hrr.SERIAL_PER=per.serial_per AND
							per.serial_sec=2 AND
							SERIAL_EPL=".$serial_epl." 
						and fechorario_hrr >='".$GLOBALS['fecha_ini']."' AND fechorario_hrr<='".$GLOBALS['fecha_fin']."' and estado_hrr like 'activo'";
							
			//echo 	"</p>".$postgrado;			
						///para pregrado////
						$rspregrado = $dblink->Execute($pregrado);
						if($rspregrado->recordCount()>0)
							$varpregrado = 'SI';
						else
							$varpregrado = 'NO';
							
						///para postgrado////
						$rspostgrado = $dblink->Execute($postgrado);
						if($rspostgrado->recordCount()>0)
							$varpostgrado = 'SI';
						else
							$varpostgrado = 'NO';	
							
		$vector = array($varpregrado, $varpostgrado);		
...
function formacionProf($serial_epl,$tipo,$dblink,$limite){
	switch($tipo){
	case 'TERCER NIVEL':
	...
	WHERE 
		...
		".$tipo."order by FECREGCONESUP_FOA desc,FECHAFIN_FOA desc
		limit".$limite;		
	...
	if($arrForm = $dblink->GetAll($sqlForm)){
		...
		//	if(strcmp($arrForm[$formPos]['descripcion_foa'],$arrForm[$formPos]['tipoTitulo_foa']) == 0){
			...
			$arrFormMay = array(
				...
				"subunesco" => $arrForm[$formPos]['subunesco_foa'],
...
function HorasAcad($serial_epl,$serial_sec,$dblink){
	...
	if($arr = $dblink->GetAll($sqlGet)){
		...
		/*if ($serial_epl==110){
			...
			echo '</p> CreReg: '.$sumPerReg. " ---- CreInt: ".$sumPerInt;		
			echo '</p> perRe: '.$divRegulares. " ---- perInt: ".$divIntensivos;
			echo '</p> Re: '.$periodoRegular. " ---- Int: ".$periodoIntensivo;
			echo '</p> Re: '.$prom;
...
/*		ORDER BY
	...
	$cad = "";
	//if ($serial_epl==170) echo "<br>SQL GET Mas Horas: ".$sqlGet."<br>";
	if($arr = $dblink->GetAll($sqlGet)){		
		//print "<pre>";print_r($arr);print "<pre>";
		$cont = 0;
		$tot = count($arr);
...
function getMatDictProfesor($serial_epl,$serial_sec,$fecha_ini,$fecha_fin,$dblink){
	switch($serial_sec){
		case 'T': 	
			...
			break;		
		default:
			$programa = "AND per.serial_sec = ".$serial_sec;	
	}
	$sqlGet = "
		SELECT					
			...
			tothoras_hrr,
			 CASE 
				WHEN per.serial_sec = 1
				THEN (tothoras_hrr / 10)
				ELSE (tothoras_hrr / 3) 
			END                       AS horasSemanales
		FROM
			materiamatriculada        AS mmat,
			detallemateriamatriculada AS dmat,
			periodo                   AS per,
		...
		WHERE
					...
					AND hrr.serial_hrr = dmat.serial_hrr 
					AND dmat.serial_mat = mat.serial_mat
					AND hrr.estado_hrr like 'activo'      
					AND ((fecini_per >='".$fecha_ini."'	AND fecini_per <='".$fecha_fin."') 
					or (fechorario_hrr >='".$fecha_ini."' AND fechorario_hrr <='".$fecha_fin."'))  
					".$programa."					
					AND hrr.serial_epl = ".$serial_epl." 
				GROUP BY
					mat.serial_mat
	...
	if($arr = $dblink->GetAll($sqlGet)){
		...
		for($i=0;$i<count($arr);$i++){
			...
			$nomMateria[$i]=$arr[$i]['nombre_mat'];
			$codMateria[$i]=$arr[$i]['codigo_mat'];
			$horMateria[$i]=$arr[$i]['horasSemanales'];
	...
	/*	if($serial_epl==302){
					echo "<br>SQLGET: ".$nomMateria[1]."<br>";
					echo "<br>SQLGET: ".$codMateria[1]."<br>";
					echo "<br>SQLGET: ".$horMateria[1]."<br>";
					
				}*/
		
	
		$vector = array($nomMateria, $codMateria, $horMateria);		
		return $vector; 	
	}else{
		return false;
	}
...
//	echo "<br>SQL GET Mas Horas: ".$sqlGet."<br>";
	if($arr = $dblink->GetAll($sqlGet)){		
		...
		/*if ($serial_epl==309){
			echo "<br>SQL GET Mas Horas: ".$sqlGet."<br>";
			echo "<br> numero_horas_materia->:  ".$arrNew[0]['numero_horas_materia'];
		}*/
...
/*
Funcion que devuelve informacion de discapacidad
*/

function getDiscapacidad($serial_epl,$dblink){

	$sqlGet="select tipo_disepl,carnet_conadis_disepl,num_carnet_dispel,porcentaje_disepl from discapacidad_epl where serial_epl=".$serial_epl;
	...
	if($arr = $dblink->GetAll($sqlGet)){
		...
		for($i=0;$i<count($arr);$i++)
		{
			$tipo_disepl[$i]=$arr[$i]['tipo_disepl'];
			$carnet_conadis_disepl[$i]=$arr[$i]['carnet_conadis_disepl'];
			$num_carnet_dispel[$i]=$arr[$i]['num_carnet_dispel'];
			$porcentaje_disepl[$i]=$arr[$i]['porcentaje_disepl'];
				
		}
		
			$vector = array($tipo_disepl, $carnet_conadis_disepl, $num_carnet_dispel,$porcentaje_disepl);	
			//echo "Vector".$vector;
 			return $vector; 	
	}else{
		return false;
...
/*
Funcion que devuelve informacion de Periodo Sabático
*/

function getPeridoSabatico($serial_epl,$dblink){

	$sqlGet="select periodo_psa , fecha_inicio_psa, fecha_fin_psa from periodo_sabatico where serial_epl=".$serial_epl;
	$arrCad = array();
	if($arr = $dblink->GetAll($sqlGet)){
		
		for($i=0;$i<count($arr);$i++)
		{
			$periodo_psa[$i]=$arr[$i]['periodo_psa'];
			$fecha_inicio_psa[$i]=$arr[$i]['fecha_inicio_psa'];
			$fecha_fin_psa[$i]=$arr[$i]['fecha_fin_psa'];
			
				
		}
		
			$vector = array($periodo_psa, $fecha_inicio_psa, $fecha_fin_psa);	
			//echo "Vector".$vector;
 			return $vector; 	
	}else{
		return false;
...
function getLugarcap($serial_epl,$dblink){
$contcursosNac=0;
$contcursosInter=0;
$contcursosIMetodologia=0;
	$sqlGet="select modo_cap,metodologia_foa from capacitacionpersonal where serial_epl=".$serial_epl;
	//echo $sqlGet;
	$arrCad = array();
	if($arr = $dblink->GetAll($sqlGet)){
		...
		for($i=0;$i<count($arr);$i++)
		{
			if($arr[$i]['modo_cap']=='NACIONAL')$contcursosNac++;
			if($arr[$i]['modo_cap']=='INTERNACIONAL')$contcursosInter++;
			if($arr[$i]['metodologia_foa']=='METODOLOGICA') $contcursosIMetodologia++;
			}
		
			}
		$vector = array($contcursosNac, $contcursosInter, $contcursosIMetodologia);	
		return $vector; 	
...
/*
Funcion que devuelve informacion de cursando Estudio
*/

function getEstudios($serial_epl,$op, $dblink){
switch($op){
	case 1:
							$sqlGet="SELECT
			epl.SERIAL_EPL,
		...
		WHERE
			epl.SERIAL_EPL=foa.SERIAL_EPL 
			AND epl.SERIAL_EPL=".$serial_epl."
			AND FECHAFIN_FOA='000-00-00' 
			AND (foa.serial_nac=3 
			OR foa.serial_nac=5) 
			AND nac.serial_nac=foa.serial_nac 
		ORDER BY
			foa.FECHAINICIO_FOA";
			break;
			
	case 2: $sqlGet="SELECT
    foa.financiamiento_foa 
FROM
    formacionacademica AS foa,
    empleado           AS epl,
    nivelacademico     AS nac 
    ...
    FECHAINICIO_FOA";
				...
				//echo $sqlGet;
					if($arr = $dblink->GetAll($sqlGet)){
						...
						if ($op==1)$NivelAcFinanciamiento[0]=$arr[0]['nombre_nac'];
						else $NivelAcFinanciamiento[0]=$arr[0]['financiamiento_foa'];
							}
		return $NivelAcFinanciamiento[0]; 	
	
}
function getPublicaciones($serial_epl,$serial_pti,$fecha_ini,$fecha_fin,$dblink){

	$sqlGet = "SELECT
    serial_pbl,
    nombre_pbl,
    participacion_pbl,
    numero_ISBN_pbl, revision_pbl,
	nombre_revista_articulo_pbl,
    YEAR(fecha_pbl) AS anio,
	estado_pbl,
	revista_indexada_articulo_pbl,
	basedatos_revista_indexada_pbl
	
FROM
    publicacionesprofesor AS pbl,
    publicacionmodalidad  AS pmod 
WHERE
    pbl.serial_pmod=pmod.serial_pmod and 
    fecha_pbl >='".$fecha_ini."' AND 
    fecha_pbl <='".$fecha_fin."' AND 
    serial_pti=".$serial_pti." AND
    serial_epl=".$serial_epl." 
ORDER BY
    fecha_pbl ASC";
	...
	if($arr = $dblink->GetAll($sqlGet)){
		...
		for($i=0;$i<count($arr);$i++){			
			$nomPublicacion[$i]=$arr[$i]['nombre_pbl'];
			$anioPublicacion[$i]=$arr[$i]['anio'];
			$participacion_pbl[$i]=$arr[$i]['participacion_pbl'];
			$numero_ISBN_pbl[$i]=$arr[$i]['numero_ISBN_pbl'];
			$revision_pb[$i]=$arr[$i]['revision_pb'];	
			$nombre_revista_articulo_pbl[$i]=$arr[$i]['nombre_revista_articulo_pbl'];	
			$estado_pbl[$i]=$arr[$i]['estado_pbl'];	
			$revista_indexada_articulo_pbl[$i]=$arr[$i]['revista_indexada_articulo_pbl'];
			$basedatos_revista_indexada_pbl[$i]=$arr[$i]['basedatos_revista_indexada_pbl'];					
		}
		
						
	if($serial_pti== 2) $vector = array($nomPublicacion, $anioPublicacion, $participacion_pbl, $numero_ISBN_pbl, $revision_pb);
	 
	else $vector = array($nomPublicacion, $nombre_revista_articulo_pbl,$anioPublicacion, $participacion_pbl, $estado_pbl, $revista_indexada_articulo_pbl, $basedatos_revista_indexada_pbl);		
