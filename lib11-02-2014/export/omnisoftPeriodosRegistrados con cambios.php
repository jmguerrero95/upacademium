...
//        require('omnisoftPDFIndividualMallas.php');
	...
	//	echo "fecha_ini:".$fecha_ini;
		...
		if($alu == 'T'){
			...
			$aluvar = " and alumno.serial_alu = ".$alu;
		}
...
<table width="100%" align="center">
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		?>
		<td width="1%" class="textovertical"><span class="style2">TOTAL CREDITOS</span></td>
		<td width="1%" class="textovertical"><span class="style2">PROMEDIO</span></td>
