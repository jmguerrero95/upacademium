...
<table width="85%" align="center">
  ...
  <tr>
    <td colspan="5" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		//echo $result_alumnos->fields['serial_mmat'];
		//$showList = verificarPagoCreditos($result_alumnos->fields['serial_mmat'],$dblink);	
		//if($showList=="SHOW"){
		?>
			<tr> 
			<td><span class="style2"><? echo $i;?></span></td>
			<td NOWRAP><span class="style2"><? echo $result_alumnos->fields['alumno'];?></span></td>
			<td NOWRAP><span class="style4"><? echo strtolower($result_alumnos->fields['mailuniv_alu']);?></span></td>
			<? echo $celdas;?>			</tr>
