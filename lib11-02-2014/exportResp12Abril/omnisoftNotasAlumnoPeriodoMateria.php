...
$sqlNot = "SELECT 
materiamatriculada.serial_alu,concat_ws(' ',apellidopaterno_alu,apellidomaterno_alu,nombre1_alu,nombre2_alu) as nombre, notasalumnos.serial_dmat
codigo_mat, nombre_mat as materia, 
...
notatotal_nal,notaalfabetica_nal,estado_nal,nombre_per,(numerocreditos_dmat) creditosmateria,(numerocreditos_dmat+creditosequivalentes_dmat) creditostomados,notasalumnos.serial_cale 
...
WHERE 
periodo.serial_sec=".$serial_sec." 
and materia.serial_mat=detallemateriamatriculada.serial_mat 
and detallemateriamatriculada.serial_mat = ".$serial_mat."
and materiamatriculada.serial_per = ".$serial_per."
order by fecini_per,materia";
...
<table width="80%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="71%" bgcolor="#FFFFFF"><table width="100%" border="0">
      <tr bgcolor="#FFFFFF">
        <th ><span class="style1">CERTIFICACION DE NOTAS POR MATERIA </span></th>
      </tr>
	  <tr bgcolor="#FFFFFF">
