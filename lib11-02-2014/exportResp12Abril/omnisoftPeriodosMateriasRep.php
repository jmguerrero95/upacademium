    ...
    <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
        <tr>
		  ...
		  <th width="10%" bgcolor="#999999"><span class="style2">Fecha Matricula </span></th>
				...
				<?php  if($j==0){
						echo $imprimir."  ( ".$rsMain->fields['nalumnos']." Alumnos) ";
						$i++;						
					  }else{
						echo "&nbsp;";																		
					  }
				?> </span></td>
				<td NOWRAP><span class="style2"><?php echo $k." .- ".$rsAlumnos->fields['nombre'];?> </span></td>
				<td NOWRAP><span class="style2"><?php echo $rsAlumnos->fields['fechamatricula_mmat'];?> </span></td>
				</tr>
				<?php 
						$rsAlumnos->MoveNext();
						$j++;
