...
$result_cobros =$dblink->Execute("select numero_cre,NOMBRE_FORC,concat_ws('-',serie_caf,numero_caf) numfac,valor_dre,numeroDocumento_dre,fecha_dre,nombre_ban, plazo_dre,referencia_dre,lote_dre,tarjetahabiente_dre,fecha_cre  
...
and fecha_caf>='".$fecha_ini."' and fecha_caf<='".$fecha_fin."' and tipo_caf='FAC' and cabecerafactura.serial_suc=".$_COOKIE['serial_suc']."
