...
$sql = "select concat_ws(' ',apellidopaterno_alu,apellidomaterno_alu,nombre1_alu,nombre2_alu) as nombre,
codigoIdentificacion_alu as identificacion, 
codigo_alu, sex.descripcion_sex as sexo, 
alu.serial_sex,mailuniv_alu,nombre_fac,
alu.fectitulo_alu as ftitulacion,
...
and alu.fectitulo_alu >= '".$fecha_ini."' and alu.fectitulo_alu <='".$fecha_fin."' 
