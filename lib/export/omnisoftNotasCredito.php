...
//echo $sql;
  ...
  //echo "echo".'select serial_dfa, nombre_ara, cantidad_dfa,valor_aal,(cantidad_dfa*valor_aal) as subtotal, descuento_dfa,detallefactura.serial_caf, detallearancel.serial_dar,iva_ara from aranceles,detallearancel,detallefactura where detallearancel.serial_dar=detallefactura.serial_dar  and aranceles.serial_ara=detallearancel.serial_ara and detallefactura.serial_caf='.$serial_caf.' order by nombre_ara';
  
  $resultSetFactura->RecordCount();
...
<table width="642" height="300"  align="left"  >
 <!-- <tr bgcolor="#FFFFFF">
  ...
  --->
  <tr>
    <th width="191" height="104" bgcolor="#FFFFFF">&nbsp;</th>
    <th height="104" colspan="2" align="center"  >&nbsp;</th>
    <th width="60" height="104" align="left" >&nbsp;</th>
  </tr>
      ...
      <tr>
        <th colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
          <tr>
            ...
            <th width="65%" height="0" align="left" valign="bottom" ><? echo $n_malla; ?></th>
...
//					echo "---".$serial_caf;
     ...
     <tr>
      ...
      <tr>
        ...
        <th height="20" align="right" ><? echo number_format(-1*($resultSetFactura->fields['valor_aal']),2); ?></th>
        <th height="20" align="right" ><? echo number_format(-1*($resultSetFactura->fields[4]),2); ?></th>
      </tr>
      <?
...
USD</th>
      ...
      <th height="0" align="right" valign="bottom" ><? echo number_format(-1*$baseimponible,2); ?></th>
    </tr>
    <tr>
      <th height="18">&nbsp;</th>
      <th height="0" align="left" >&nbsp;</th>
    ...
    <tr>
      <th height="18">&nbsp;</th>
      <th height="0" align="left" >&nbsp;</th>
      <th height="0" align="right" valign="bottom" ><? echo number_format(-1*$total,2); ?></th>
    </tr>
  </table>
</div>
<!--<div id="Layer2">
