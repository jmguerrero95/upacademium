...
FROM
	...
	LEFT JOIN parroquia ON parroquia.serial_par = alu.serial_par 
WHERE
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
        ...
        <tr>
          <td  align="left" nowrap><? echo $i + 1; ?></td>
		       ...
		       <td align="right"><? echo $arrMain[$i]['nombre_par'];?></td>
		       <td align="right"><? echo $arrMain[$i]['direcciondomic_alu'];?></td>
		       <td align="right"><? echo $arrMain[$i]['fechaInscripcion_alu'];?></td>
		       <td align="right"><? echo $arrMain[$i]['codigoIdentificacion_alu'];?></td>
        ...
        <?php 
         ...
         <tr>
          <th colspan="10" ><div align="right">TOTAL MATRICULADOS : </div></th>
		  <th >&nbsp;</th>
		  <th >&nbsp;</th>
		  <th ><?php  echo $totAll; ?> </th>
		  </tr>
		  <tr>
          <th colspan="13" align="center" ><div align="right">
