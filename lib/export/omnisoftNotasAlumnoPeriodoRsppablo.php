...
WHERE
	...
	AND detallemateriamatriculada.serial_mat in (
        ...
        WHERE
			...
			and materia.serial_mat in (282,281)
...
$totalCreditosMalla = $totalCreditosHomologados + $totalCreditosRevalidados + $totalCreditosAprueba;
...
<table width="80%" align="center">
  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><table width="100%" border="1">
      ...
      <tr>
        <th colspan="3" align="right">Ver Materias  Fuera de Malla: </th>
        ...
        <tr>
		 ...
		 <!-- <tr>
		  ...
		  <th >&nbsp; </th>		  
		   ...
		   <tr>
		     <th colspan="7" ><div align="right">TOTAL CREDITOS TOMADOS:</div></th>
		     <th ><?php echo $totalCreditos; ?></th>
		     <th >&nbsp;</th>
		     <th >&nbsp;</th>
        </tr>
	      <tr>
          <th colspan="7" ><div align="right">TOTAL CREDITOS MALLA</div></th>
		  <th ><?php echo $totalCreditosMalla; ?></th>
		  <th >&nbsp;</th>
		  <th >&nbsp; </th>		  
		  </tr>
    </table>
