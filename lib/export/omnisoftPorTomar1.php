...
if ($serial_sec!='T')
	$seccion= " and mmat.serial_sec = ".$serial_sec;	
else
	$seccion= "";
...
union select 0,0,'zzzzzzzzzzzzzzzzzzzz',0,0,0
ORDER BY nombre";
...
<table width="100%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <th colspan="2">CREDITOS POR TOMAR DE LA MALLA DEL ALUMNO </th>
  </tr>
  <tr >
...
<tr>
					...
					<th align="right"><? echo "TOTALES";?></span></th>										
