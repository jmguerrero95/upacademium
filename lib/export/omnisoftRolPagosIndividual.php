...
$ingresos="select NOMBRE_RGR,VALOR_DRP from rubrogeneralrolpagos,detallerolpagos where valor_drp>0 and tipo_rgr='INGRESO' and  desplegarrol_rgr='SI' and rubrogeneralrolpagos.serial_rgr=detallerolpagos.serial_rgr and serial_erp=".$serial_erp."
			union 
			select concat_ws(' ',NOMBRE_RGR,'Adc.') NOMBRE_RGR,VALOR_DRP from rubrogeneralrolpagos,detallerolpagos where valor_drp>0 and tipo_rgr='INGRESO' and  desplegarrol_rgr='SI' and rubrogeneralrolpagos.serial_rgr=detallerolpagos.serial_rgr and serial_erp	in (select empleadorolpagos.SERIAL_ERP from empleado,empleadorolpagos where  empleado.serial_epl=empleadorolpagos.serial_epl and empleadorolpagos.serial_perrol=".$rsEmpleado->fields['SERIAL_PERROL']." and DOCUMENTOIDENTIDAD_EPL = '".$rsEmpleado->fields['DOCUMENTOIDENTIDAD_EPL']."' ) and serial_erp<>".$serial_erp;
$rsIngresos=$dblink->Execute($ingresos);
//echo "</p>".$ingresos;

$egresos="select NOMBRE_RGR,VALOR_DRP from rubrogeneralrolpagos,detallerolpagos where valor_drp>0 and tipo_rgr='EGRESO' and desplegarrol_rgr='SI' and rubrogeneralrolpagos.serial_rgr=detallerolpagos.serial_rgr and serial_erp=".$serial_erp."
			union 
			select concat_ws(' ',NOMBRE_RGR,'Adc.') NOMBRE_RGR,VALOR_DRP from rubrogeneralrolpagos,detallerolpagos where valor_drp>0 and tipo_rgr='EGRESO' and  desplegarrol_rgr='SI' and rubrogeneralrolpagos.serial_rgr=detallerolpagos.serial_rgr and serial_erp	in (select empleadorolpagos.SERIAL_ERP from empleado,empleadorolpagos where  empleado.serial_epl=empleadorolpagos.serial_epl and empleadorolpagos.serial_perrol=".$rsEmpleado->fields['SERIAL_PERROL']." and DOCUMENTOIDENTIDAD_EPL = '".$rsEmpleado->fields['DOCUMENTOIDENTIDAD_EPL']."' ) and serial_erp<>".$serial_erp;
