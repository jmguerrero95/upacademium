...
for($i=0;$i<$totAll;$i++){	
	...
	if($key == ""){
		$sumOtrosTwo++;
		$arrSinForm[$sumOtros]['serial_epl'] = $arrMain[$i]['serial_epl'];
		$arrSinForm[$sumOtros]['nombre'] = $arrMain[$i]['apellido_epl']." ".$arrMain[$i]['nombre_epl'];
		$arrSinForm[$sumOtros]['sucursal'] = $arrMain[$i]['nombre_suc'];
	}else{	
...
for($i=0;$i<$totArrMainPrior;$i++){
	...
	for($j=0;$j<$totArrCat;$j++){
		$cat = $arrCat[$j];		
		if($contClase[$key][$cat]!=0){
			$sumCont = $sumCont + $contClase[$key][$cat];
		}


	}	
}
//echo "<br>TOTAL: ".$sumCont."<br>";
//echo "<pre>".print_r($arrSinForm)."<pre>"
...
<link rel="stylesheet" type="text/css" href="jqueryui/css/defpei.css" media="screen" />
	<link rel="stylesheet" href="jqueryui/development-bundle/themes/base/jquery.ui.all.css">	
	<script src="jqueryui/development-bundle/jquery-1.5.1.js"></script>
...
<table summary="Profesores PEI">
	<caption>Listado Profesores PEI</caption>
	<thead>
	<tr>
	...
	<tbody>
		...
		<tr<?php echo $class;//?>>
			<th scope="row" id="<?php echo "r".$i+1;?>"><a href="#" ><?php echo $arrMain[$i]['codigo_institucion'];?></a></th>
				...
				<td><?php echo $arrMain[$i]['nombre_epl'] ?></td>
	...
	<tbody>
		<tr class="odd">
			<th scope="row" id=""><a href="#"><?php echo $totMasculino; ?></a></th>
				...
				<td><a href="#"><?php echo $totNoDef;?></a></td>
		</tr>
	</tbody>
</table>
...
<!--END GENERO-->
	...
	<table width="526" cellpadding="0" cellspacing="0" border="1">
      ...
      <tr height="20">
        ...
        <td><?php echo $totFormMasNomb['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA'];?></td>
        <td><?php echo $totFormFemNomb['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA'];?></td>
        <td><?php echo $totFormMasCont['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA'];?></td>
        <td><?php echo $totFormFemCont['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA'];?></td>
        <td><?php echo $totFormMasNomb['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA']+$totFormFemNomb['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA']+$totFormMasCont['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA']+$totFormFemCont['IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA'];?></td>
      </tr>
      <tr height="20">
	...
	<div>
	    ...
	    <table cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td rowspan="2" >&nbsp;</td>
            <td colspan="6"><?php echo "Desde: ".$fecha_ini."Hasta: ".$fecha_fin; ?></td>
          </tr>
          <tr>
            <td>0-9 hrs.  </td>
            <td>10-19    hrs.  </td>
          ...
          <tr>
            ...
            <td><?php  echo $contClase["TECNICO SUPERIOR"]["A"]+$contClase["TECNICO SUPERIOR"]["B"]+$contClase["TECNICO SUPERIOR"]["C"]+$contClase["TECNICO SUPERIOR"]["D"]+ $contClase["TECNICO SUPERIOR"]["E"];?></td>
          </tr>
          <tr>
		    ...
		    <td><?php  echo $contClase["TECNOLOGO"]["A"]+$contClase["TECNOLOGO"]["B"]+$contClase["TECNOLOGO"]["C"]+$contClase["TECNOLOGO"]["D"]+ $contClase["TECNOLOGO"]["E"];?></td>			
          </tr>
          <tr>
            <td>Tercer    Nivel </td>
		    ...
		    <td><?php echo $contClase["TERCER NIVEL"]["A"]+$contClase["TERCER NIVEL"]["B"]+$contClase["TERCER NIVEL"]["C"]+$contClase["TERCER NIVEL"]["D"]+ $contClase["TERCER NIVEL"]["E"];?></td>
          </tr>
          <tr>
            <td>Doctor en    jurisprudencia o filosofía </td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["A"];?></td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["B"];?></td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["C"];?></td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["D"];?></td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["E"];?></td>
            <td><?php echo $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["A"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["B"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["C"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["D"]+ $contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["E"];?></td>
		  </tr>
          <tr>
			...
			<td><?php  echo $contClase["DIPLOMADO"]["A"]+$contClase["DIPLOMADO"]["B"]+$contClase["DIPLOMADO"]["C"]+$contClase["DIPLOMADO"]["D"]+ $contClase["DIPLOMADO"]["E"];?></td>
          </tr>
          <tr>
            <td>Especialista </td>
			...
			<td><?php  echo $contClase["ESPECIALISTA"]["A"]+$contClase["ESPECIALISTA"]["B"]+$contClase["ESPECIALISTA"]["C"]+$contClase["ESPECIALISTA"]["D"]+ $contClase["ESPECIALISTA"]["E"];?></td>
          </tr>
          <tr>
            <td>Maestría </td>
            <td><?php echo $contClase["MAGISTER"]["A"];?></td>
            <td><?php echo $contClase["MAGISTER"]["B"];?></td>
            <td><?php echo $contClase["MAGISTER"]["C"];?></td>
            <td><?php echo $contClase["MAGISTER"]["D"];?></td>
            <td><?php echo $contClase["MAGISTER"]["E"];?></td>
			<td><?php echo $contClase["MAGISTER"]["A"]+$contClase["MAGISTER"]["B"]+$contClase["MAGISTER"]["C"]+$contClase["MAGISTER"]["D"]+$contClase["MAGISTER"]["E"];?></td>
          </tr>
          <tr>
            <td>Ph.D</td>
            ...
            <td><?php echo $contClase["DOCTORADO"]["A"]+$contClase["DOCTORADO"]["B"]+$contClase["DOCTORADO"]["C"]+$contClase["DOCTORADO"]["D"]+$contClase["DOCTORADO"]["E"];?></td>
          </tr>
          <tr>
            <td>En ninguna categoria </td>
            <td colspan="6"><?php echo $sumOtrosTwo;?></td>
          </tr>
          <tr>
            <td>Total</td>
            <td><strong>
            <?php  $a = $contClase["TECNICO SUPERIOR"]["A"]+$contClase["TECNOLOGO"]["A"]+$contClase["TERCER NIVEL"]["A"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["A"]+$contClase["DIPLOMADO"]["A"]+$contClase["ESPECIALISTA"]["A"]+$contClase["MAGISTER"]["A"]+$contClase["DOCTORADO"]["A"]; echo $a;?>
            </strong></td>
            <td><strong>
            <?php $b = $contClase["TECNICO SUPERIOR"]["B"]+$contClase["TECNOLOGO"]["B"]+$contClase["TERCER NIVEL"]["B"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["B"]+$contClase["DIPLOMADO"]["B"]+$contClase["ESPECIALISTA"]["B"]+$contClase["MAGISTER"]["B"]+$contClase["DOCTORADO"]["B"];echo $b;?>
            </strong></td>
            <td><strong>
            <?php $c= $contClase["TECNICO SUPERIOR"]["C"]+$contClase["TECNOLOGO"]["C"]+$contClase["TERCER NIVEL"]["C"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["C"]+$contClase["DIPLOMADO"]["C"]+$contClase["ESPECIALISTA"]["C"]+$contClase["MAGISTER"]["C"]+$contClase["DOCTORADO"]["C"];echo $c;?>
            </strong></td>
            <td><strong>
            <?php $d =$contClase["TECNICO SUPERIOR"]["D"]+$contClase["TECNOLOGO"]["D"]+$contClase["TERCER NIVEL"]["D"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["D"]+$contClase["DIPLOMADO"]["D"]+$contClase["ESPECIALISTA"]["D"]+$contClase["MAGISTER"]["D"]+$contClase["DOCTORADO"]["D"];echo $d;?>
            </strong></td>
            <td><strong>
            <?php $e =$contClase["TECNICO SUPERIOR"]["E"]+$contClase["TECNOLOGO"]["E"]+$contClase["TERCER NIVEL"]["E"]+$contClase["IV DOCTOR EN JURISPRUDENCIA O FILOSOFIA"]["E"]+$contClase["DIPLOMADO"]["E"]+$contClase["ESPECIALISTA"]["E"]+$contClase["MAGISTER"]["E"]+$contClase["DOCTORADO"]["E"];echo $e;?>
            </strong></td>
			 <td><strong><?php echo $a+$b+$c+$d+$e;?></strong></td>
          </tr>
        </table>
	</div>
	...
	<div>
		<table cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><?php echo "Desde: ".$fecha_ini."Hasta: ".$fecha_fin; ?></td>
          </tr>
          <tr>
            <td>Hombres</td>
            <td><?php echo $edadHombres; ?></td>
          </tr>
          <tr>
            <td>Mujeres</td>
            <td><?php echo $edadMujeres; ?></td>
          </tr>
		  <tr>
            <td>Hombres y Mujeres </td>
            <td><?php echo $edadTodos; ?></td>
          </tr>
		  		  <tr>
            <td>Profesores sin edad </td>
            <td><?php echo $edadError; ?></td>
          </tr>
