...
<link rel="stylesheet" href="blue/style.css" type="text/css" media="screen" />
	...
	<script type="text/javascript" src="../jqinc/jquery.tablesorter.js"></script>
	...
	<script type="text/javascript">
	$(function() {		
		$("#tablequick").tablesorter({sortList:[[0,0],[2,1]], widgets: ['zebra']});
...
<table id="tablequick" class="tablesorter" summary="Profesores PEI" >
	<caption>
	...
	<th>Titulo TN</th>
	<th>Universidad TN</th>
	<th>Nivel TN</th>
	<th>Pais TN</th>
	<th>Registro CNSUP TN</th>
	<th>Titulo CN</th>
	<th>Universidad CN</th>
	<th>Nivel CN</th>
	<th>Pais CN</th>
	<th>Reg CNSUP CN</th>
	<th>Fecha Ing Iess</th>
	<th>Relac Trab Iess</th>
	<th>Cargo Adm o Acad</th>
	<th>Categoria</th>
	<th>Dedicacion</th>
	<th>Unidad Academ</th>
	<th>Horas Acad</th>
	...
	<th>Horas Invest</th>	
	<th>Horas Vs</th>	
	<th>Sist Eval Docent</th>
	<th>PART EVENT ACAD</th>
	<th>PER SABAT</th>
	<th>ACAD EXTRANJ</th>
	<th>INVES PERM</th>
	<th>INVES ESP</th>
	...
	<tbody>
		...
		?>
		<tr>
			<td><a href="#" ><?php echo $arrMain[$i]['codigo_institucion'];?></a><td>
