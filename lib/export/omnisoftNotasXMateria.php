...
<script>
		function fbuscar(){
			...
			var query='omnisoftNotasXMateriapart2.php?nombre_sec=<?php echo $nombre_sec;?>&serial_hrr=<?php echo  $serial_hrr;?>&serial_nts=<?php echo  $serial_nts;?>&nombre_mat=<?php echo  $nombre_mat;?>&apellido_epl=<?php echo  $apellido_epl;?>&nombre_epl=<?php echo  $nombre_epl;?>';
...
<table width="85%" align="center">
  ...
  <tr>
	...
	if($nombre_sec==$value) 
	   {
	   ?> <th align="left"> <a href="#" onClick="fbuscar()"><span class='style3'>  <? echo $nombre_mat; ?> </span></th>  <?  
	   }else{ ?>
