...
if($numReg<=0){
	...
	<center>
	<strong>
			Alerta: No se hallaron registros con la selección...
	</strong>
	</center>
	<br>
	";
...
<table width="100%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <th colspan="2"><span class="style1">ALUMNOS POR PROCESO </span></th>
  </tr>
  <tr >
  ...
  <tr>
    ...
    <th align="left"><?php echo $proceso_alu?></th>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
        <tr>
          ...
          <th width="5%" bgcolor="#999999">Proceso</th>
		...
		<? 
			...
			?>
				...
				<td NOWRAP ><span class="style2"><? echo $rsAlumnos->fields['proceso_alu'];?></span></td>
