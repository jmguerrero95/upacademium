      ...
      <tr>
        <th colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
          <tr>
            ...
            <th width="65%" height="18" align="left" valign="bottom" ><? echo  $mallanombre; ?></th>
            <th width="16%" height="18" align="left" valign="bottom" >
			<? 
          ...
          <tr>
            ...
            <th height="18" align="left" valign="bottom" >
				<? 
          ...
          <tr>
			...
			<? 
				...
				if($resultClienteUpac->fields['serial_cliu'] > 0){
					...
					echo $resultSede->fields['apellidopaterno_alu']." ".$resultSede->fields['apellidomaterno_alu']." ".$resultSede->fields['nombre1_alu']." ".$resultSede->fields['nombre2_alu']; 
				}
			?>&nbsp;
