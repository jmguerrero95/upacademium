...
<script>
function fbuscar(){
	var query='http://172.20.3.236/upacifico/upacademium/lib/export/omnisoftNotasAlumnoPeriodoFM.php?serial_alu=<?php echo $serial_alu;?>&serial_sec=<?php echo $serial_sec;?>';
...
//Inclusion en promedio general notas creditos homologados
for($i=0;$i<$totHom;$i++){		
...
//Procesamiento de Creditos Normales
...
//Procesamiento de Creditos Homologados

echo "<br> totalCreditosRegistroHom: ".$totalCreditosRegistroHom."<br>";
echo "<br> totalNotaNumericaPorCreditoHom: ".$totalNotaNumericaPorCreditoHom."<br>";
$promedioSobreCuatroHom = number_format($totalNotaNumericaPorCreditoHom/$totalCreditosRegistroHom,3);
//echo "<br> promedioSobreCuatroHom: ".$promedioSobreCuatroHom."<br>";
...
<table width="80%" align="center">
  ...
  <tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		<?php  
		 ...
		 for($i=0;$i<$totAll;$i++){	
		  ...
		  <tr>
		     ...
		     <td align="right" nowrap><? echo $arrMain[$i]['tipomateria'];?></td>
		  </tr>
      ...
      <BR>
      <a href="#" onclick="fbuscar()"><img src="../../images/buscar.png" alt="Buscar" width="30" height="30" border="0" /></a></td>
    <BR>
    <br /></td>
  </tr>
  <tr>
