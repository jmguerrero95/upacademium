...
$totalvalidacionconocimientos = 0;
...
<table width="100%" align="center">
  ...
  <tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
	    ...
	    <tr>
		    <td colspan="7" class='style2'><div align="right">Total Validación Conocimientos:  </div></td>
		    <td  class='style3'><?php echo $$totalvalidacionconocimientos;?></td>
		    <td >&nbsp;</td>
	    </tr>
		<tr>
