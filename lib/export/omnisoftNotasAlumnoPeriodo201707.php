...
$totalCreditosExamenAvanzada=0;//cambiar a 0
...
for($i=0;$i<$totHom;$i++){		
	...
	/*var_dump($arr);*/
	// en ciartos alumnos $arr llega vacio
	if($arr){
		$arrHom[$i]['notaalfabeticah'] = $arr[0]['notaalfabeticah'];		
		$arrHom[$i]['notanumericah'] = $arr[0]['notanumericah'];	// Aqui se setea la notanumerica	
...
WHERE
	...
	AND (fecharetiro_dmat <>'000-00-00' 
	AND retiromateria_dmat ='CON COSTO') 
  ...
  <tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		?>
		    ...
		    <td align="right" class="style3"><? echo $arrHom[$j]['notanumericah'];?></td><!-- aqui es el problemas-->
		...
		<tr>
		  ...
		  <td >&nbsp;</td>
		   ...
		   <tr>
		     <td colspan="7" class='style2'><div align="right">Total Créditos Tomados (Aprobados / Reprobados/Homologados/Revalidados) </div></td>
