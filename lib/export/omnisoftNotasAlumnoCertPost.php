...
$sqlRegistro = "
	SELECT
		...
		nombre2_alu) AS alumno,materiamatriculada.serial_mmat,
		mailuniv_alu 
	FROM
		alumno,
		materiamatriculada,
	...
	WHERE
		alumno.serial_alu=materiamatriculada.SERIAL_ALU 
	...
	ORDER BY
		alumno
";
//echo "<br>".$sqlRegistro."<br>";
$result_alumnos=$dblink->Execute($sqlRegistro);
...
$valorfecha=$rsPeriodo->fields['fecini_per'];

//echo $valorfecha;

if ($valorfecha>= '2015-01-01')
{
  ...
  <tr>
    <td colspan="2" bgcolor="#FFFFFF"><table width="99%" border="1">
      <tr>
        ...
        <th width="37%" rowspan="3" align="right"><div align="left">A = <strong>Act.en Clase...............<? echo $ac ?>% </strong><br />
          T = Trabajos......................<? echo $tb ?>% <br />
          E.P. = EX. Parcial..............<? echo $pp ?>% <br />
          E.F. = EX. Final..................<? echo $ef ?>% </div></th>
        </tr>
      <tr>
	...
	<table width="99%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		...
		<? 
		  ...
		  <?php 
			...
			if($showList[0]['show'] == "SI"){
				echo $result_alumnos->fields['alumno'];
			}else{
				echo "<strong>".$result_alumnos->fields['alumno'].". *</strong>";
			}
		...
		?> 
		    <tr>
		      <th colspan="7" ><div align="left">Nota: Los alumnos resaltados con negrita y con un &quot;* &quot; tienen problemas financieros.</div></th>
        </tr>
	    <tr>
