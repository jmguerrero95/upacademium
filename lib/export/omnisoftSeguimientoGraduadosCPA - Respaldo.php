...
<table width="90%" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <th colspan="2"><span class="style1">LISTA DE ALUMNOS CON FECHA DE CUMPLEA&Ntilde;OS </span></th>
  </tr>
  <tr >
  ...
  <tr>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" vspace="0">
		  ...
		  <th width="7%">Cumplea&ntilde;os</th>
		...
		?> 
			...
			?>
				...
				<td ><span class="style1"><? echo $rsalumnos->fields['fecnac_alu'];?> <span class="">hell</span> </span></td>
				...
				<td ><span class="style2"><? echo $rsalumnos->fields['fegresamiento'];?></span></td>
				...
				and eal.serial_maa = maa.serial_maa and esp.serial_esp=eal.serial_esp and eal.serial_suc=".$serial_suc."
