...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportActa.php">
...
function omnisoftImportFile() {
  ...
  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademium/actasnotas/'.$_FILES['foto']['name'];
