...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportDocumento.php">
...
$archivo='';
function omnisoftImportDocumento() {
  global  $_FILES,$_GET,$archivo;

  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademiumprueba/documento/'.$_FILES['foto']['name'];
