...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportTitulos.php">
<input name="foto" type="file" id="foto" size="30" maxlength="255"  >
<input name="ingresofoto" type="hidden" id="ingresofoto"  value="1" >
<input name="campoarchivo" type="hidden" id="campoarchivo"  value="<?php echo $_GET['campoarchivo'];?>" onClick="window.close();">
...
function omnisoftImportFile() {
  ...
  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademium/aTituloAlumno/'.$_FILES['foto']['name'];
  //echo "directorio:".$_SERVER['DOCUMENT_ROOT'];
if (is_uploaded_file($_FILES['foto']['tmp_name'])) {
  ...
  if (omnisoftImportFile()==1)   {
    //echo '<center><image name="imgfoto" width="180" height="180" src="../../contratos/'.$_FILES['foto']['name'] .'"></center>';
