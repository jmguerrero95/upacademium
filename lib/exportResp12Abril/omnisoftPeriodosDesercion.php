...
<title>FORMULARIO DE DESERCION</title>
<style type="text/css">
<!--
...
and periodo1.fecini_per>= '".$fecha_ini."' and periodo1.fecini_per<'".$fecha_fin."' and periodo1.serial_sec=".$serial_sec." and periodo.serial_per=materiamatriculada.serial_per and periodo.fecini_per>='".$fecha_ini."' and periodo.fecini_per < aveDATE_ADD('".$fecha_fin."', INTERVAL 360 DAY) and fecharetiro_dmat='0000-00-00' and (intercambio_alu <> 'INTERCAMBIO' and intercambio_alu <> 'COMUNIDAD')
group by serial_alu,serial_per
order by nombre,fecha_registro";
echo "<br> IVANCHODSQL. <br>".$sql_alumnos."<br>";
