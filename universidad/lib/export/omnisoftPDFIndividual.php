...
//------------------------------------------------------------------------------------------------------------------------
         ...
         class OmnisoftPDFIndividual extends FPDF {
               ...
               var $activeColumnDetailArray; // OBJECT, arreglo de todas las columnas
                ...
                function addColumn($AdisplayColumnName, $Awidth=20,$value=0,$posX=0,$posY=0,$Atype="string",$Aalign="left")
                {
                ...
                function Header()
                {
                 ...
                 $this->Image($this->slogo,20,12,18,18);
                ...
                $rowno=0;
			     ...
			     $rec=substr($arrayElement["value"],0,$width);
                                  ...
                                  if  ( $arrayElement["type"]=="string")
                                         ...
                                         $this->Cell($arrayElement["width"],6,number_format($rec),'LR',0,'L',$fill);
