...
<form method="POST" enctype="multipart/form-data"  name="PaginaDatos" action="omnisoftImportCurriculum.php">
...
function omnisoftImportFile() {
  ...
  $archivo=$_SERVER['DOCUMENT_ROOT'].'/upacifico/upacademium/curriculum/'.$_FILES['foto']['name'];
