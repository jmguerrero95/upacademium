   ...
   this.showGrid=function (gridName,pRows,pHeight,pWidth,pFont,pBGColor) {
        ...
        for (var i=0,j=0; i < this.columnCount; i++) {
            ...
            if (this.column[i].type=='nota') {
                   ...
                   template.getContent("box/text").setAttribute("MAXLENGTH", 3);
        ...
        if (fields.type=='date')   {
             ...
             if(fields.type=='nota')
                    if (parseInt(text)>100 || parseInt(text)<0) {
                        alert('Error: La nota debe estar en el rango de 0 a 100, por favor revisela!');
                        return true;
                    }
...
//              alert(resultado+' '+fields.refresh);
