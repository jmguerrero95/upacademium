...
<table width="548"  align="left"  >
  ...
  <tr>
    <th width="191" height="125" bgcolor="#FFFFFF">&nbsp;</th>
    <th height="125" colspan="2" align="center"  >&nbsp;</th>
    <th width="60" height="125" align="left" >&nbsp;</th>
  </tr>
  <tr >
    <th height="280" colspan="4" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <th colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
          <tr>
            <th width="19%" height="18" align="left" valign="bottom" >&nbsp;</th>
            <th width="65%" height="18" align="left" valign="bottom" ><? echo $resultSede->fields['nombre_maa']; ?></th>
            <th width="16%" height="18" align="left" valign="bottom" ><? echo $resultSede->fields['codigo_alu']; ?></th>
          </tr>
          <tr>
            <th height="18" align="left" valign="bottom" >&nbsp;</th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['cliente_caf']; ?></th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['cedula_caf']; ?></th>
          </tr>
          <tr>
            <th height="18" align="left" valign="bottom" >&nbsp;</th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['apellidopaterno_alu']." ".$resultSede->fields['apellidomaterno_alu']." ".$resultSede->fields['nombre1_alu']." ".$resultSede->fields['nombre2_alu']; ?>&nbsp;</th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['codigoIdentificacion_alu']; ?></th>
          </tr>
          <tr>
            <th height="18" align="left" valign="bottom" >&nbsp;</th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['fecha_caf']; ?></th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['telefodomic_alu']; ?></th>
          </tr>
          <tr>
            <th height="18" align="left" valign="bottom" >&nbsp;</th>
            <th height="18" align="left" valign="bottom" ><? echo $resultSede->fields['direcciondomic_alu']; ?></th>
            <th height="18" align="left" valign="bottom" ><? echo $numero_caja; ?></th>
          </tr>
        </table></th>
      </tr>
      <tr>
        <th width="8%" height="24" >&nbsp;</th>
        <th width="51%" height="24" >&nbsp;</th>
        <th width="12%" height="24" >&nbsp;</th>
        <th width="13%" height="24" >&nbsp;</th>
        <th width="16%" height="24" >&nbsp;</th>
      </tr>
      <? 
			  $cont=0;
...
<div id="Layer1">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <th height="30" colspan="2" rowspan="5" align="left" valign="top" >&nbsp;
        <?  echo numerosDecimal($total);?>
USD</th>
      <th height="30">&nbsp;</th>
      <th height="30" align="left" >&nbsp;</th>
      <th height="30" align="right" valign="bottom" ><? echo number_format($baseimponible,2); ?></th>
    </tr>
    <tr>
      <th height="30">&nbsp;</th>
      <th height="30" align="left" >&nbsp;</th>
      <th height="30" align="right" valign="bottom" ><? echo number_format($descuentos,2); ?></th>
    </tr>
    <tr>
      <th height="30">&nbsp;</th>
      <th height="30" align="left" >&nbsp;</th>
      <th height="30" align="right" valign="bottom" ><? echo number_format($total,2); ?></th>
    </tr>
    <tr>
      <th height="30">&nbsp;</th>
      <th height="30" align="left" >&nbsp;</th>
      <th height="30" align="right" valign="bottom" >-</th>
    </tr>
    <tr>
      <th height="30">&nbsp;</th>
      <th height="30" align="left" >&nbsp;</th>
...
<div id="Layer2">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <th width="72%" height="30" align="left">&nbsp;</th>
      <th width="28%" height="30" align="right" valign="bottom"><? echo number_format($total,2); ?></th>
    </tr>
    <tr>
      <th height="30" align="left">&nbsp;</th>
      <th height="30" align="right" valign="bottom">776</th>
    </tr>
    <tr>
      <th height="30" align="left">&nbsp;</th>
      <th height="30" align="right" valign="bottom">888</th>
    </tr>
  </table>
</div>
</body>
