...
if($rsaccion!='') {
	...
	$okeditusu=in_array("acceditarusu",$rsaccion);
...
<?php if (!empty($_SESSION['nombre_age']))
    {?>
<table align="right" border="0" width="99%"><tr>
    <td colspan="30" align="right"><font color="#000000" size="4" face="Arial, Helvetica, sans-serif"><strong>Centro de Costo 
      : <? echo $_SESSION['nombre_age'] ?></strong></font></td>
  </tr></table><br><br>   
<?php
   }
?>