...
where alumnomalla.serial_alu=materiamatriculada.SERIAL_ALU and malla.serial_maa=alumnomalla.serial_maa  and serial_maa_p=0 and materiamatriculada.SERIAL_MMAT='.$serial_mmat.' 
union
	...
	<br />
      <table width="100%" border="1">
		...
		while (!$rsMaterias->EOF) {?>
			...
			<td><span class="style2"><? echo $rsMaterias->fields['NOMBREHORARIO_HRR']." - ".$rsMaterias->fields['seccion_hrr'];?></span></td>
