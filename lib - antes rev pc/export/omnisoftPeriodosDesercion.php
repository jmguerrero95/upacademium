...
and periodo1.fecini_per>= '".$fecha_ini."' and periodo1.fecini_per<'".$fecha_fin."' and periodo1.serial_sec=".$serial_sec." and periodo.serial_per=materiamatriculada.serial_per and periodo.fecini_per>='".$fecha_ini."' and periodo.fecini_per<DATE_ADD('".$fecha_fin."', INTERVAL 360 DAY) and fecharetiro_dmat='0000-00-00'
