...
function generarapresupuesto(){
	...
	$sucursal = $par[1]; // sede		
//	$periodoYaño=$par[2]; // periodo + fecha

	$periodoYaño = explode("*",$par[2]); //periodo + fecha
	
//	$año = $periodoYaño[1];
	
	$año = explode("-",$periodoYaño[1]);

	$periodo_unificado = $periodoYaño[0];
	$año =	$año[0];
...
$fecha_ini = $año."-01-01"; //fecha del año sigueinte
$fecha_fin = $año."-12-31"; //fecha del añoa siguiente
...
//					select * from presupuestooperativo where ANIO_POP = 2009 and SERIAL_SUC = 2
				...
				$control = "select * from presupuestooperativo where ANIO_POP = ".$año." and SERIAL_SUC = ".$sucursal;
			...
			echo "Num cred:  ".$totalCreditos."  valor:  ".$totalValor." Mes: ".$mes[1]."fech per".$fechaInicio." AÑO: ".$año."</p>";	
								if($retexistente->RecordCount()>0){
								 ...
								 $presupuesto = "update presupuestooperativo set ".$meses[$n][2]." = ".$totalValor.", ".$meses[$n][1]." = ".$totalCreditos." where SERIAL_SUC = ".$sucursal." and ANIO_POP = ".$año;
					...
					$upadeteTotales = "update presupuestooperativo set VALOR_POP = ".$valorTotal.", CANTIDAD_POP = ".$cantidadTotal.", APROBADO_POP = 'NO' where SERIAL_SUC = ".$sucursal." and ANIO_POP = ".$año;
